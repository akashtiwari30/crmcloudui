...
class dUnzip2{
	...
	Function getList($stopOnFile=false){
		...
		if($this->debug){
			...
			$kkk = 0;
			echo "<table border='0' style='font: 11px Verdana; border: 1px solid var(--black-color-2)'>";
			...
			if(sizeof($this->endOfCentral)){
				echo "<table border='0' style='font: 11px Verdana' style='border: 1px solid var(--black-color-2)'>";
