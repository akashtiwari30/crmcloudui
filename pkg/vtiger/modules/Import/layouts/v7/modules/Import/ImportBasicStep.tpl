					...
					<div class='footer-btns'>
						...
						{else}
							...
							<div id="importStepTwoButtonsDiv" class = "hide">
								...
								<button name="next" class="btn btn-submit btn-lg" id="uploadAndParse" onclick="Vtiger_Import_Js.uploadAndParse('1');">{vtranslate('LBL_NEXT_BUTTON_LABEL', $MODULE)}</button>
