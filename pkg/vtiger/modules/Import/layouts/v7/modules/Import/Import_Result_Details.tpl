...
<table width="100%" class="table table-borderless">
	<tr>
		<td class = "secondary-color">{'LBL_TOTAL_RECORDS_IMPORTED'|@vtranslate:$MODULE}</td>
		<td width="10%">:</td>
		<td class = "secondary-color" width="30%">{$IMPORT_RESULT.IMPORTED} / {$IMPORT_RESULT.TOTAL}</td>
	</tr>
	<tr>
		<td class = "secondary-color" width="20%">{'LBL_NUMBER_OF_RECORDS_CREATED'|@vtranslate:$MODULE}</td>
		<td width="1%">:</td>
		<td  class = "secondary-color" width="60%">{$IMPORT_RESULT.CREATED}
