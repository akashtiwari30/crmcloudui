...
<div class="col-sm-12 col-xs-12 extensionContents">
	<div class="row">
		<div class="col-sm-12 col-xs-12">
			<h4 class="module-title pull-left"> {vtranslate('LBL_SELECT_MODULES_TO_SYNC', $MODULE)} </h4>
		</div>
	</div>
	<br>
	<form name="settingsForm" action="index.php" method="POST" >
		...
		{if !$IS_SYNC_READY}
			<div class="row">
				<div class="col-sm-12 col-xs-12">
					<h4 class="module-title pull-left"> {vtranslate('LBL_GOOGLE_CONNECT_MSG', $MODULE)} </h4>
				</div>
			</div>
			<br>
			<div class="row">
		...
		{else}
			<div class="row">
				<div class="col-sm-12 col-xs-12">
					<h4 class="module-title pull-left"> {vtranslate('LBL_GOOGLE_ACCOUNT_DETAILS', $MODULE)} </h4>
				</div>
			</div>
			<br>
			{if $USER_EMAIL}
			...
			<div class="col-sm-12 col-xs-12">
				<div class="vt-default-callout vt-info-callout marginLeft10px"> 
					...
					<div>
						...
						{vtranslate('LBL_REDIRECT_URL', $MODULE)} : <span style="color: var(--black-color-2) !important">{Google_Config_Connector::getRedirectUrl()}</span>
					</div>
					<br>
