    ...
    <div class='padding10 span12'>     
       ...
       {/if}
        <div class='row-fluid'>
            ...
            <button id="sync_button" class="btn btn-submit span9"  data-url='index.php?module=Google&view=List&operation=sync&sourcemodule={$SOURCEMODULE}'><b>{vtranslate('LBL_SYNC_BUTTON',$MODULE_NAME)}</b></button>
