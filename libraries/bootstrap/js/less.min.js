...
(function (a, b) {
        ...
        if (
          ...
          try {
            new d.Parser({
              ...
              if (d) return u(d, i);
              try {
                c(d, e, a, b, { local: !1, lastModified: g, remaining: f }),
  ...
  function q(a, b, c, e) {
    ...
    var g = r(),
      h = f ? !1 : d.async;
    typeof g.overrideMimeType == "function" && g.overrideMimeType("text/css"),
      g.open("GET", a, h),
      g.setRequestHeader(
        "Accept",
    ...
    (d.Parser = function v(a) {
      ...
      function A(a, b) {
        ...
        (this.type = a.type || "Syntax"),
          ...
          (this.callLine = a.call && z(a.call, c).line + 1),
          (this.callExtract = g[z(a.call, c).line]),
          (this.stack = a.stack),
          (this.column = f),
          ...
          push: function (b, c) {
            ...
            this.queue.push(b),
              d.Parser.importer(
                ...
                this.paths,
                function (a, d, f) {
                  e.queue.splice(e.queue.indexOf(b), 1),
                    (e.files[b] = d),
                    (e.contents[b] = f),
                    a && !e.error && (e.error = a),
                    c(a, d),
              ...
              (k = (function (c) {
                ...
                for (var l = 0, m, n; l < b.length; l++) {
                  (e.lastIndex = l),
                    (i = e.exec(b)) &&
                      i.index === l &&
                      ((l += i[0].length), j.push(i[0])),
                    (m = b.charAt(l)),
                    (f.lastIndex = g.lastIndex = l),
                    (i = g.exec(b)) &&
                      i.index === l &&
          ...
          parsers: {
            ...
            entities: {
              ...
              arguments: function () {
                var a = [],
                  b;
                while (
                  (b = t(this.entities.assignment) || t(this.expression))
                ) {
                  a.push(b);
                  if (!t(",")) break;
                }
            ...
            mixin: {
              call: function () {
                ...
                t("(") && (h = t(this.entities.arguments)) && t(")"),
                  t(this.important) && (k = !0);
                if (c.length > 0 && (t(";") || w("}")))
                ...
                if (
                  ...
                  do {
                    ...
                    if (h instanceof e.Variable)
                      if (t(":"))
                        (i = u(this.expression, "expected expression")),
                  ...
                  u(")"),
                    t(/^when/) &&
                      (j = u(this.conditions, "expected condition")),
                    (g = t(this.block));
            ...
            selector: function () {
              ...
              if (t("("))
                return (
                  (a = t(this.entity)),
                  u(")"),
                  new e.Selector([new e.Element("", a, f)])
                );
    ...
    (function (a) {
      (a.Import = function (b, c, d, e) {
        ...
        (this.index = e),
          ...
          b instanceof a.Quoted
            ? (this.path = /\.(le?|c)ss(\?.*)?$/.test(b.value)
                ? b.value
                : b.value + ".less")
            : (this.path = b.value.value || b.value),
    ...
    (function (a) {
      (a.Media = function (b, c) {
        ...
        (this.features = new a.Value(c)),
          (this.ruleset = new a.Ruleset(e, b)),
          (this.ruleset.allowImports = !0);
      }),
        (a.Media.prototype = {
          toCSS: function (a, b) {
            ...
            return (
              (this.ruleset.root = a.length === 0 || a[0].multiMedia),
              "@media " +
                c +
                (b.compress ? "{" : " {\n  ") +
                this.ruleset.toCSS(a, b).trim().replace(/\n/g, "\n  ") +
          ...
          eval: function (b) {
            ...
            var d = new a.Media([], []);
            return (
              (d.features = this.features.eval(b)),
              b.frames.unshift(this.ruleset),
              (d.ruleset = this.ruleset.eval(b)),
              b.frames.shift(),
              (b.mediaBlocks[c] = d),
              b.mediaPath.pop(),
              b.mediaPath.length === 0 ? d.evalTop(b) : d.evalNested(b)
            );
          },
          variable: function (b) {
            return a.Ruleset.prototype.variable.call(this.ruleset, b);
        ...
        (a.Ruleset.prototype = {
          eval: function (b) {
            ...
            for (var e = 0, f; e < d.rules.length; e++)
              (f = d.rules[e]),
                f instanceof a.mixin.Definition ||
          ...
          rulesets: function () {
            return this._rulesets
              ...
              : (this._rulesets = this.rules.filter(function (b) {
                  return (
                    b instanceof a.Ruleset || b instanceof a.mixin.Definition
                  );
                }));
          },
          find: function (b, c) {
          ...
          toCSS: function (b, c) {
            ...
            for (var j = 0; j < this.rules.length; j++)
              (i = this.rules[j]),
                i.rules || i instanceof a.Directive || i instanceof a.Media
                  ? f.push(i.toCSS(g, c))
  ...
  (d.refresh = function (a) {
    var b, c;
    (b = c = new Date()),
      m(function (a, d, e, f, g) {
        g.local
          ? t("loading " + f.href + " from cache.")
          : (t("parsed " + f.href + " successfully."),
            p(d.toCSS(), f, g.lastModified)),
          t("css for " + f.href + " generated in " + (new Date() - c) + "ms"),
          g.remaining === 0 && t("css generated in " + (new Date() - b) + "ms"),
          (c = new Date());
      }, a),
      l();
  }),
