                ...
                children: [
                  {
                    ...
                    children: [
                      { type: "html", html: "<div></div>" },
                      {
                        ...
                        style:
                          "border:1px solid #eeeeee;font-size:28px;height:40px;width:70px;padding-top:9px;text-align:center;",
                        html: "<div>&nbsp;</div>",
                      },
                      {
                        type: "html",
                        ...
                        className: "cke_dark_background",
                        style:
                          "border:1px solid #eeeeee;font-size:14px;height:20px;width:70px;padding-top:2px;text-align:center;",
                        html: "<div>&nbsp;</div>",
                      },
                    ],
                  },
