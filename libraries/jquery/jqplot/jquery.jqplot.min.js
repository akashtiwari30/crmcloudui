...
(function (H) {
  ...
  H.jqplot = function (ah, ae, ac) {
    ...
    if (H.jqplot.config.catchErrors) {
      try {
        ...
        document.getElementById(ah).style.background =
          H.jqplot.config.errorBackground;
        document.getElementById(ah).style.border = H.jqplot.config.errorBorder;
        document.getElementById(ah).style.fontFamily =
          H.jqplot.config.errorFontFamily;
        document.getElementById(ah).style.fontSize =
          H.jqplot.config.errorFontSize;
        document.getElementById(ah).style.fontStyle =
          H.jqplot.config.errorFontStyle;
        document.getElementById(ah).style.fontWeight =
          H.jqplot.config.errorFontWeight;
      }
    } else {
      ag.init(ah, ad, ab);
      ag.draw();
  ...
  H.jqplot.version = "1.0.2";
  H.jqplot.revision = "1108";
  ...
  H.jqplot.CanvasManager = function () {
    ...
    this.getCanvas = function () {
      ...
      if (!H.jqplot.use_excanvas) {
        for (
          var af = 0, ac = H.jqplot.CanvasManager.canvases.length;
          af < ac;
          af++
        ) {
  ...
  H.jqplot.support_canvas = function () {
    if (typeof H.jqplot.support_canvas.result == "undefined") {
      H.jqplot.support_canvas.result =
  ...
  H.jqplot.use_excanvas =
    H.browser.msie && !H.jqplot.support_canvas() ? true : false;
  ...
  H.jqplot.ElemContainer.prototype.createElement = function (
    ae,
    ag,
    ac,
    ad,
  ...
  s.prototype.resetDataBounds = function () {
    ...
    if (
      ad &&
      this.renderer.constructor === H.jqplot.LinearAxisRenderer &&
      ai.min >= 0
    ) {
      this.padMin = 1;
  ...
  O.prototype.toggleDisplay = function (ac, ae) {
    ...
    if (ad) {
      if (ab.canvas._elem.is(":hidden") || !ab.show) {
        ...
        ab.canvas._elem
          .nextAll(".jqplot-point-label.jqplot-series-" + ab.index)
          .fadeIn(ad);
      } else {
        ab.show = false;
  ...
  function N() {
    ...
    this.init = function (ao, al, aq) {
      ...
      for (var am = 0; am < this.series.length; am++) {
        ...
        for (var ak = 0; ak < H.jqplot.preSeriesInitHooks.length; ak++) {
          H.jqplot.preSeriesInitHooks[ak].call(
            this.series[am],
            ao,
            this.data,
        ...
        for (var ak = 0; ak < this.preSeriesInitHooks.hooks.length; ak++) {
          this.preSeriesInitHooks.hooks[ak].call(
            this.series[am],
            ao,
            this.data,
            this.options.seriesDefaults,
        ...
        for (var ak = 0; ak < H.jqplot.postSeriesInitHooks.length; ak++) {
          H.jqplot.postSeriesInitHooks[ak].call(
            this.series[am],
            ao,
            this.data,
            this.options.seriesDefaults,
        ...
        for (var ak = 0; ak < this.postSeriesInitHooks.hooks.length; ak++) {
          this.postSeriesInitHooks.hooks[ak].call(
            this.series[am],
            ao,
            this.data,
            this.options.seriesDefaults,
    ...
    this.reInitialize = function (an, af) {
      ...
      for (var ao = 0, ak = this.series.length; ao < ak; ao++) {
        ...
        for (var am = 0; am < H.jqplot.preSeriesInitHooks.length; am++) {
          H.jqplot.preSeriesInitHooks[am].call(
            this.series[ao],
            ap,
            this.data,
            this.options.seriesDefaults,
            this.options.series[ao],
            this
          );
        }
        for (var am = 0; am < this.preSeriesInitHooks.hooks.length; am++) {
          this.preSeriesInitHooks.hooks[am].call(
            this.series[ao],
            ap,
            this.data,
            this.options.seriesDefaults,
        ...
        for (var am = 0; am < H.jqplot.postSeriesInitHooks.length; am++) {
          H.jqplot.postSeriesInitHooks[am].call(
            this.series[ao],
            ap,
            this.data,
            this.options.seriesDefaults,
        ...
        for (var am = 0; am < this.postSeriesInitHooks.hooks.length; am++) {
          this.postSeriesInitHooks.hooks[am].call(
            this.series[ao],
            ap,
            this.data,
            this.options.seriesDefaults,
    ...
    this.quickInit = function () {
      ...
      for (var ai = 0; ai < this.series.length; ai++) {
        ...
        if (
          this.series[ai]._type === "line" &&
          this.series[ai].renderer.bands.show
        ) {
          this.series[ai].renderer.initBands.call(
            this.series[ai],
            this.series[ai].renderer.options,
            this
          );
        }
    ...
    this.parseOptions = function (aq) {
      ...
      for (var al = 0; al < this.data.length; al++) {
        ...
        for (
          var ak = 0;
          ak < H.jqplot.preParseSeriesOptionsHooks.length;
          ak++
        ) {
          H.jqplot.preParseSeriesOptionsHooks[ak].call(
            ap,
            this.options.seriesDefaults,
            this.options.series[al]
          );
        }
        for (
          var ak = 0;
          ak < this.preParseSeriesOptionsHooks.hooks.length;
          ak++
        ) {
          this.preParseSeriesOptionsHooks.hooks[ak].call(
            ap,
            this.options.seriesDefaults,
            this.options.series[al]
          );
        ...
        var ah = "vertical";
        if (
          ap.renderer === H.jqplot.BarRenderer &&
          ap.rendererOptions &&
          ap.rendererOptions.barDirection == "horizontal" &&
          ap.transposeData === true
        ) {
          ah = "horizontal";
        }
        ...
        if (ap.show) {
          ...
          if (ap._xaxis.scaleToHiddenSeries) {
            ap._xaxis.show = true;
          }
          if (ap._yaxis.scaleToHiddenSeries) {
            ap._yaxis.show = true;
          }
        }
        if (!ap.label) {
        ...
        for (
          var ak = 0;
          ak < H.jqplot.postParseSeriesOptionsHooks.length;
          ak++
        ) {
          H.jqplot.postParseSeriesOptionsHooks[ak].call(
            this.series[al],
            this.options.seriesDefaults,
            this.options.series[al]
          );
        ...
        for (
          var ak = 0;
          ak < this.postParseSeriesOptionsHooks.hooks.length;
          ak++
        ) {
          this.postParseSeriesOptionsHooks.hooks[ak].call(
            this.series[al],
            this.options.seriesDefaults,
            this.options.series[al]
          );
    ...
    this.draw = function () {
      if (this.drawIfHidden || this.target.is(":visible")) {
        ...
        for (aB = 0, ay = this.preDrawHooks.length; aB < ay; aB++) {
          this.preDrawHooks.hooks[aB].apply(
            this,
        ...
        for (aB = 0, ay = aD; aB < ay; aB++) {
          ...
          this.target.append(
            ak[az].shadowCanvas.createElement(
              this._gridPadding,
        ...
        for (
          var aB = 0, ay = H.jqplot.eventListenerHooks.length;
          aB < ay;
          aB++
        ) {
        ...
        for (
          var aB = 0, ay = this.eventListenerHooks.hooks.length;
          aB < ay;
          aB++
        ) {
          this.eventCanvas._elem.bind(
        ...
        if (
          aq.fill &&
          aq.series1 !== aq.series2 &&
          aq.series1 < aD &&
          aq.series2 < aD &&
          ak[aq.series1]._type === "line" &&
        ...
        for (aB = 0, ay = aD; aB < ay; aB++) {
          ...
          if (
            ...
            ao.canvas._elem.jqplotEffect(
              "blind",
              { mode: "show", direction: ap.animation.direction },
              ap.animation.speed
            );
            ao.shadowCanvas._elem.jqplotEffect(
              "blind",
              { mode: "show", direction: ap.animation.direction },
              ap.animation.speed
            );
        ...
        switch (aI.renderer.constructor) {
          ...
          case H.jqplot.BubbleRenderer:
            ...
            if (aI.show) {
              for (var aO = 0; aO < aI.gridData.length; aO++) {
                aK = aI.gridData[aO];
                aR = Math.sqrt(
                  (aD - aK[0]) * (aD - aK[0]) + (aC - aK[1]) * (aC - aK[1])
                );
          ...
          case H.jqplot.LineRenderer:
            ...
            if (aI.show) {
              if (
                (aI.fill ||
                  (aI.renderer.bands.show && aI.renderer.bands.fill)) &&
                (!ag.plugins.highlighter || !ag.plugins.highlighter.show)
              ) {
                var aq = false;
                if (
                  aD > aI._boundingBox[0][0] &&
            ...
            switch (aw) {
              case "xaxis":
                if (
                  ah.showGridline &&
                  this.drawGridlines &&
                  ((!ah.isMinorTick && ab.drawMajorGridlines) ||
                    (ah.isMinorTick && ab.drawMinorGridlines))
                ) {
                ...
                if (
                  ah.showMark &&
                  ah.mark &&
                  ((!ah.isMinorTick && ab.drawMajorTickMarks) ||
                    (ah.isMinorTick && ab.drawMinorTickMarks))
                ) {
                  aj = ah.markSize;
                  ak = ah.mark;
                  var ae = Math.round(ab.u2p(ah.value)) + 0.5;
  ...
  function F(aD) {
    ...
    for (var af = 1, av = aD.length; af < av; af++) {
      ...
      for (var aw = 0; aw < 2; aw++) {
        ...
        if (ay == 0 || ay == ab) {
          ...
          if (ap[ay + 1] - ap[ay] == 0 || ap[ay] - ap[ay - 1] == 0) {
            ...
            if (
              (ae[ay + 1] - ae[ay]) / (ap[ay + 1] - ap[ay]) +
                (ae[ay] - ae[ay - 1]) / (ap[ay] - ap[ay - 1]) ==
              0
            ) {
              ac[aw] = 0;
            } else {
              if ((ap[ay + 1] - ap[ay]) * (ap[ay] - ap[ay - 1]) < 0) {
                ...
                ac[aw] =
                  2 /
                  (ao(ae[ay + 1], ae[ay]) / (ap[ay + 1] - ap[ay]) +
                    ao(ae[ay], ae[ay - 1]) / (ap[ay] - ap[ay - 1]));
              }
            }
          }
        }
      ...
      if (af == 1) {
        ...
        if (af == ab) {
          ac[1] =
            ((3 / 2) * (ap[ab] - ap[ab - 1])) / ao(ae[ab], ae[ab - 1]) -
            ac[0] / 2;
        }
      }
      an[0] =
        (-2 * (ac[1] + 2 * ac[0])) / ao(ae[af], ae[af - 1]) +
        (6 * (ap[af] - ap[af - 1])) / Math.pow(ao(ae[af], ae[af - 1]), 2);
      an[1] =
        (2 * (2 * ac[1] + ac[0])) / ao(ae[af], ae[af - 1]) -
        (6 * (ap[af] - ap[af - 1])) / Math.pow(ao(ae[af], ae[af - 1]), 2);
      aj = ((1 / 6) * (an[1] - an[0])) / ao(ae[af], ae[af - 1]);
      ak =
        ((1 / 2) * (ae[af] * an[0] - ae[af - 1] * an[1])) /
        ao(ae[af], ae[af - 1]);
      al =
        (ap[af] -
          ap[af - 1] -
          ak * (Math.pow(ae[af], 2) - Math.pow(ae[af - 1], 2)) -
          aj * (Math.pow(ae[af], 3) - Math.pow(ae[af - 1], 3))) /
        ao(ae[af], ae[af - 1]);
      aq =
        ap[af - 1] -
        al * ae[af - 1] -
        ak * Math.pow(ae[af - 1], 2) -
  ...
  function B(aj) {
    ...
    for (var aK = 0, aJ = aj.length - 1; aK < aJ; aK++) {
      if (aO === null) {
        am = Math.abs(
          (aj[aK + 1][1] - aj[aK][1]) / (aj[aK + 1][0] - aj[aK][0])
        );
        aM = 0.3;
        aq = 0.6;
        az = (aq - aM) / 2;
        ...
        if (aK > 0) {
          aL = Math.abs(
            (aj[aK][1] - aj[aK - 1][1]) / (aj[aK][0] - aj[aK - 1][0])
          );
        }
        ag = aL / aA + ay;
        ...
        if (au) {
          ...
          if (this.renderer.bands.show) {
            ...
            if (this.renderer.bands.fill) {
              if (this.renderer.smooth) {
                ag = this.renderer._hiBandSmoothedData.concat(
                  this.renderer._lowBandSmoothedData.reverse()
                );
              } else {
                ag = this.renderer._hiBandGridData.concat(
  ...
  function g(af, ae, ai, ah, ag) {
    if (ah) {
      ...
      if (
        ag.series[ad[0]].highlightMouseOver &&
  ...
  function d(ae, ad, ah, ag, af) {
    if (ag) {
      ...
      if (
        af.series[ac[0]].highlightMouseDown &&
  ...
  H.jqplot.LinearAxisRenderer.prototype.createTicks = function (ad) {
    ...
    if (aE.length) {
      ...
      if (
        ...
        var aJ = H.jqplot.LinearTickGenerator(
          a0,
          aC,
          this._scalefact,
          aq,
        ...
        if (a0 < ap || aC > aK) {
          ...
          aJ = H.jqplot.LinearTickGenerator(
            ap,
            aK,
            this._scalefact,
            aq,
        ...
        if (this.autoscale && this.min == null && this.max == null) {
          ...
          if (aw) {
            this.numberTicks =
              2 + Math.ceil((ab - (this.tickSpacing - 1)) / this.tickSpacing);
            this.min = 0;
            aB = 0;
            ...
            if (aH) {
              ...
              if (this.numberTicks == null) {
                if (this.tickInterval) {
                  ...
                  this.numberTicks =
                    2 +
                    Math.ceil((ab - (this.tickSpacing - 1)) / this.tickSpacing);
                }
              }
              if (this.tickInterval == null) {
                ...
                if (af < 1) {
                  am = Math.pow(
                    10,
                    Math.abs(Math.floor(Math.log(af) / Math.LN10))
                  );
                } else {
                  am = 1;
                }
                ...
                if (aZ == null && aB == null) {
                  ...
                  if (aZ == null) {
                    ...
                    if (aB == null) {
                      ...
                      this.numberTicks =
                        Math.ceil((aZ - aB) / this.tickInterval) + 1;
                      this.min =
                        Math.floor(aB * Math.pow(10, aX)) / Math.pow(10, aX);
                      this.max =
                        Math.ceil(aZ * Math.pow(10, aX)) / Math.pow(10, aX);
                      this.numberTicks =
    ...
    if (this.breakPoints) {
      ...
      this.u2p = function (au) {
        ...
        if (au <= this.breakPoints[0]) {
          ...
          return (
            ((au - this.breakPoints[1] + this.breakPoints[0] - am) * ae) / af +
            ag
          );
        }
      };
      if (this.name.charAt(0) == "x") {
        ...
        this.series_u2p = function (au) {
          ...
          if (au >= this.breakPoints[1]) {
            ...
            return (
              ((au + this.breakPoints[1] - this.breakPoints[0] - an) * ae) / af
            );
          }
        };
        this.series_p2u = function (au) {
              ...
              switch (aj.labelPosition) {
                ...
                case "end":
                  if (aq * aj.angle < 0) {
                    ab =
                      (-aj._textRenderer.height *
                        Math.cos(-aj._textRenderer.angle)) /
                      2;
                  } else {
                    ab =
                      -aj.getHeight() +
  ...
  H.jqplot.MarkerRenderer.prototype.drawDiamond = function (
    ad,
    ac,
    ag,
    af,
  ...
  H.jqplot.ShadowRenderer.prototype.draw = function (ao, am, aq) {
    ...
    ao.strokeStyle =
      ab.strokeStyle || this.strokeStyle || "rgba(0,0,0," + ad + ")";
    ao.fillStyle = ab.fillStyle || this.fillStyle || "rgba(0,0,0," + ad + ")";
    for (var ae = 0; ae < ah; ae++) {
      var al = H.jqplot.LinePattern(ao, ak);
      ao.translate(
        Math.cos((this.angle * Math.PI) / 180) * af,
        Math.sin((this.angle * Math.PI) / 180) * af
      );
      al.beginPath();
      if (ap) {
    ...
    if (this.show) {
      if (this.placement == "insideGrid") {
        switch (this.location) {
          ...
          case "n":
            var ac =
              (ad.left + (this._plotDimensions.width - ad.right)) / 2 -
              this.getWidth() / 2;
            var ab = ad.top;
            this._elem.css("left", ac);
            this._elem.css("top", ab);
          ...
          case "e":
            var ac = ad.right;
            var ab =
              (ad.top + (this._plotDimensions.height - ad.bottom)) / 2 -
              this.getHeight() / 2;
            this._elem.css({ right: ac, top: ab });
            break;
          case "se":
    ...
    if (!this.themes.hasOwnProperty(au)) {
      ...
      for (var ar in ao.axes) {
        ...
        if (ae.show) {
          ...
          at =
            ag.axesStyles.borderColor != null
          ...
          at =
            ag.axesStyles.borderWidth != null
  ...
  H.fn.jqplotToImageCanvas = function (ad) {
    ...
    var af =
      ad.backgroundColor == null ? "rgb(255,255,255)" : ad.backgroundColor;
        ...
        if (aH === "table" && H(aA).hasClass("jqplot-table-legend")) {
          ...
          H(aA)
            ...
            .each(function () {
              ...
              var aN =
                aO.innerHeight() - 2 * parseInt(aO.css("padding-top"), 10);
              var aJ =
                aO.innerWidth() - 2 * parseInt(aO.css("padding-left"), 10);
          ...
          H(aA)
            ...
            .each(function () {
              ...
              var aK =
                aF + aL.position().top + parseInt(aL.css("padding-top"), 10);
  ...
  H.jqplot.sprintf = function () {
    function ah(an, aj, ak, am) {
      var al =
        an.length >= aj ? "" : Array((1 + aj - an.length) >>> 0).join(ak);
    ...
    function ae(al) {
      ...
      for (var aj = 10; aj > 0; aj--) {
        if (
          ...
          (ak = ak.replace(
            /^(\d+)(\d{3})/,
            "$1" + H.jqplot.sprintf.thousandsSeparator + "$2"
          ))
        ) {
          break;
        }
    ...
    var ac = arguments,
      ...
      ag = ac[af++];
    return ag.replace(
      H.jqplot.sprintf.regex,
      function (aG, aq, ar, av, aI, aD, ao) {
        if (aG == "%%") {
          return "%";
        }
        var ax = false,
        ...
        switch (ao) {
          ...
          case "G":
            ...
            var aB = al < 0 ? "-" : at;
            var am = ["toExponential", "toFixed", "toPrecision"][
              "efg".indexOf(ao.toLowerCase())
            ];
