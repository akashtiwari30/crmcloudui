...
class Potentials_DetailView_Model extends Vtiger_DetailView_Model {
	...
	public function getDetailViewLinks($linkParams) {
		...
		$customActionLink = array(
			'linktype' => 'DETAILVIEWBASIC',
			'linklabel' => 'Extend Trial Period',
			'linkurl' => 'javascript:Potentials_Detail_Js.detailCurrentInstance.extendTrial()',
			'linkicon' => 'fa fa-magic'
		);
		array_unshift($linkModelList['DETAILVIEWBASIC'], Vtiger_Link_Model::getInstanceFromValues($customActionLink));
