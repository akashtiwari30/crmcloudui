<?php
/* Smarty version 4.5.4, created on 2025-07-10 11:10:21
  from 'C:\wamp64\www\cloudcrm\layouts\v7\modules\Settings\Vtiger\CustomRecordNumbering.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_686f9f9dbf7c19_87777886',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8b90893f5829b4b5cd10c27b869e0430ed9abf5e' => 
    array (
      0 => 'C:\\wamp64\\www\\cloudcrm\\layouts\\v7\\modules\\Settings\\Vtiger\\CustomRecordNumbering.tpl',
      1 => 1752064015,
      2 => 'file',
    ),
  ),
...
function content_686f9f9dbf7c19_87777886 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
</h4></div></div><div class="table form-horizontal no-border" id="customRecordNumbering" ><?php $_smarty_tpl->_assignInScope('DEFAULT_MODULE_DATA', $_smarty_tpl->tpl_vars['DEFAULT_MODULE_MODEL']->value->getModuleCustomNumberingData());
...
"><div class=" col-lg-6 col-md-6 col-sm-6"><select class="select2 inputElement " name="sourceModule"><?php
...
"><div class=" col-lg-6 col-md-6 col-sm-6"><input type="text" id="prefix" class="inputElement" value="<?php echo $_smarty_tpl->tpl_vars['DEFAULT_MODULE_DATA']->value['prefix'];?>
...
"><div class=" col-lg-6 col-md-6 col-sm-6"><input type="text" value="<?php echo $_smarty_tpl->tpl_vars['DEFAULT_MODULE_DATA']->value['sequenceNumber'];?>
...
" data-rule-required = "true" data-rule-positive="true" data-rule-wholeNumber="true" name="sequenceNumber"/></div></div></div><div class='modal-overlay-footer clearfix'><div class="row clearfix"><div class=' textAlignCenter col-lg-12 col-md-12 col-sm-12 '><button class="btn btn-submit saveButton" type="submit" disabled="disabled"><?php echo vtranslate('LBL_SAVE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</a></div></div></div></div></div></form></div><?php }
}
