<?php
/* Smarty version 4.5.4, created on 2025-07-10 11:57:04
  from 'C:\wamp64\www\cloudcrm\layouts\v7\modules\Settings\Vtiger\CompanyDetails.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_686faa9047dcd6_94149817',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'bb6a4208b23d32ac7d0921afebf47ad6498ea373' => 
    array (
      0 => 'C:\\wamp64\\www\\cloudcrm\\layouts\\v7\\modules\\Settings\\Vtiger\\CompanyDetails.tpl',
      1 => 1752064015,
      2 => 'file',
    ),
  ),
...
function content_686faa9047dcd6_94149817 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['FIELD']->value => $_smarty_tpl->tpl_vars['FIELD_TYPE']->value) {
$_smarty_tpl->tpl_vars['FIELD_TYPE']->do_else = false;
if ($_smarty_tpl->tpl_vars['FIELD']->value != 'logoname' && $_smarty_tpl->tpl_vars['FIELD']->value != 'logo') {?><div class="form-group companydetailsedit"><label class="col-sm-3 fieldLabel control-label "><?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD']->value,$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);
if ($_smarty_tpl->tpl_vars['FIELD']->value == 'organizationname') {?>&nbsp;<span class="redColor">*</span><?php }?></label><div class="fieldValue col-sm-6"><?php if ($_smarty_tpl->tpl_vars['FIELD']->value == 'address') {?><textarea class="form-control col-sm-6 resize-vertical" rows="2" name="<?php echo $_smarty_tpl->tpl_vars['FIELD']->value;?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?><div class="modal-overlay-footer clearfix"><div class="row clearfix"><div class="textAlignCenter col-lg-12 col-md-12 col-sm-12"><button type="submit" class="btn btn-submit saveButton"><?php echo vtranslate('LBL_SAVE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
