...
</h6></div><div style="list-style: none;"><?php if (php7_count($_smarty_tpl->tpl_vars['RELATION_FIELDS']->value) == 0) {?><div class="well" style="height:72px;opacity:0.6;text-align:center;padding-top: 30px;"><div><span><?php echo vtranslate('LBL_NO_RELATION_TYPE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
.</span></div></div><?php }
...
?><div class="contentsBackground ONE_TO_ONE" data-relation-type="<?php echo $_smarty_tpl->tpl_vars['RELATION_FIELD']->value->get('_relationType');?>
...
"><div class="relationship-left-side"><div class=""><h6 class="textOverflowEllipsis" style="margin-bottom:1px" title="<?php echo vtranslate($_smarty_tpl->tpl_vars['RELATION_FIELD']->value->get('label'),$_smarty_tpl->tpl_vars['SELECTED_MODULE_NAME']->value);?>
"><?php echo vtranslate($_smarty_tpl->tpl_vars['RELATION_FIELD']->value->get('label'),$_smarty_tpl->tpl_vars['SELECTED_MODULE_NAME']->value);?>
</h6><p class="referenceModule"><?php echo vtranslate($_smarty_tpl->tpl_vars['REFERENCE_MODULE']->value,$_smarty_tpl->tpl_vars['REFERENCE_MODULE']->value);?>
</p></div><div class=""><div class="pull-right"><?php if ($_smarty_tpl->tpl_vars['RELATION_FIELD']->value->get('_relationType') == Settings_LayoutEditor_Module_Model::MANY_TO_ONE) {?><img src="<?php echo vimage_path('N-1.png');?>
" width="100" height="50" /><?php } else { ?><img src="<?php echo vimage_path('1-1.png');?>
" width="100" height="50" /><?php }?></div></div></div></div><?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></div></div><div class="col-sm-8" id="ONE_MANY_RELATIONSHIP"><div class="row" style="padding-bottom:15px;"><span class="col-sm-6"><h6><?php echo vtranslate('ONE_MANY_RELATIONSHIP',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
.</div></div><?php } else { ?><div class="col-sm-7"><ul class="relatedModulesList" style="list-style: none;margin:0px;padding-left:0px;"><?php
...
$_smarty_tpl->_assignInScope('RELATION_FIELD_MODEL', $_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getRelationField());?><li class="relatedModule module_<?php echo $_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getId();?>
 ONE_TO_MANY"data-relation-id="<?php echo $_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getId();?>
...
"/>&nbsp;&nbsp;</span><div class="col-sm-5" style="margin-top:4px;"><div class="textOverflowEllipsis"><h6 class="moduleLabel" style="margin-bottom:1px;" title="<?php echo vtranslate($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->get('label'),$_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getRelationModuleName());?>
...
</span></span><span class="col-sm-6" style="width:100%"><img src="<?php echo vimage_path('Circle.png');?>
" /><span class="marginLeft10px color-indicator"><?php echo vtranslate('LBL_RELATED_MODULE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span></span></div></div><div class="relationListInfoWrapper"><div class="col-sm-10 relationListInfo" style="margin-left: 18px;"><?php if (php7_count($_smarty_tpl->tpl_vars['RELATED_MODULES']->value) != 0) {?><div><div class="relatedListInfoHeader"><i class="fa fa-info-circle"></i>&nbsp;<span><?php echo vtranslate('LBL_INFO',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span></div><p><?php echo vtranslate('LBL_RELATED_LIST_INFO',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
.</p></div><?php }?></div></div></div><?php }?></div><br><div class="row hiddenModulesContainer <?php if (!$_smarty_tpl->tpl_vars['HIDDEN_TAB_EXISTS']->value) {?>hide<?php }?>"><div class="col-lg-6" style="padding-right: 0px;"><select class="select2 inputElement" multiple name="addToList" placeholder="<?php echo vtranslate('LBL_SELECT_HIDDEN_MODULE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
"><?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['RELATED_MODULES']->value, 'MODULE_MODEL');
$_smarty_tpl->tpl_vars['MODULE_MODEL']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['MODULE_MODEL']->value) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></select></div></div></div></div><div class='modal-overlay-footer clearfix saveRelatedListContainer hide'><div class="row clearfix"><div class='textAlignCenter col-lg-12 col-md-12 col-sm-12 '><button type='submit' class='btn btn-submit saveButton saveRelatedList' ><?php echo vtranslate('LBL_SAVE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
