<?php
/* Smarty version 4.5.4, created on 2025-07-15 06:42:37
  from 'C:\wamp64\www\cloudcrm\layouts\v7\modules\Settings\Groups\EditView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_6875f85dc60239_91917121',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '40f786e788640a0bb1d08b90f9d0741d39f99a4d' => 
    array (
      0 => 'C:\\wamp64\\www\\cloudcrm\\layouts\\v7\\modules\\Settings\\Groups\\EditView.tpl',
      1 => 1752064015,
      2 => 'file',
    ),
  ),
...
function content_6875f85dc60239_91917121 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></select></div></div></div></div><div class="form-group row"><div class="groupMembersColors"><ul class="liStyleNone"><li class="Users textAlignCenter"><p><?php echo vtranslate('LBL_USERS',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</p></li><li class="Groups textAlignCenter"><p><?php echo vtranslate('LBL_GROUPS',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</p></li><li class="Roles textAlignCenter"><p><?php echo vtranslate('LBL_ROLES',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</p></li><li class="RoleAndSubordinates textAlignCenter"><p><?php echo vtranslate('LBL_ROLEANDSUBORDINATE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</p></li></ul></div></div></div><div class='modal-overlay-footer clearfix'><div class="row clearfix"><div class='textAlignCenter col-lg-12 col-md-12 col-sm-12 '><button type='submit' class='btn btn-submit saveButton' type="submit" ><?php echo vtranslate('LBL_SAVE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
