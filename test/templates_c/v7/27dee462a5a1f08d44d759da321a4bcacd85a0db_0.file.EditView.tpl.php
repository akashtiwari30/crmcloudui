<?php
/* Smarty version 4.5.4, created on 2025-07-10 13:02:34
  from 'C:\wamp64\www\cloudcrm\layouts\v7\modules\Settings\PickListDependency\EditView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_686fb9ea6be8b3_82578986',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '27dee462a5a1f08d44d759da321a4bcacd85a0db' => 
    array (
      0 => 'C:\\wamp64\\www\\cloudcrm\\layouts\\v7\\modules\\Settings\\PickListDependency\\EditView.tpl',
      1 => 1752064015,
      2 => 'file',
    ),
  ),
...
function content_686fb9ea6be8b3_82578986 (Smarty_Internal_Template $_smarty_tpl) {
?>
<div class="editViewPageDiv"><div class="col-sm-12 col-xs-12"><div class="editViewContainer container-fluid"><br><form id="pickListDependencyForm" class="form-horizontal" method="POST"><?php if (!empty($_smarty_tpl->tpl_vars['MAPPED_VALUES']->value)) {?><input type="hidden" class="editDependency" value="true"/><?php }?><div class="editViewBody"><div class="editViewContents editdependency"><div class="form-group"><label class="muted control-label col-sm-2 col-xs-2"><?php echo vtranslate('LBL_SELECT_MODULE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</label><div class="controls col-sm-5 col-xs-5"><select name="sourceModule" class="select2 form-control marginLeftZero"><?php
...
</label><div class="controls col-sm-5 col-xs-5"><select id="sourceField" name="sourceField" class="select2 form-control" data-placeholder="<?php echo vtranslate('LBL_SELECT_FIELD',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</label><div class="controls col-sm-5 col-xs-5"><select id="targetField" name="targetField" class="select2 form-control" data-placeholder="<?php echo vtranslate('LBL_SELECT_FIELD',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
" data-rule-required="true"><option value=''></option><?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['PICKLIST_FIELDS']->value, 'FIELD_LABEL', false, 'FIELD_NAME');
$_smarty_tpl->tpl_vars['FIELD_LABEL']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['FIELD_NAME']->value => $_smarty_tpl->tpl_vars['FIELD_LABEL']->value) {
...
</div></div><?php }?></div></div></div><div class='modal-overlay-footer clearfix'><div class="row clearfix"><div class=' textAlignCenter col-lg-12 col-md-12 col-sm-12 '><button type='submit' class='btn btn-submit saveButton' ><?php echo vtranslate('LBL_SAVE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
