<?php
/* Smarty version 4.5.4, created on 2025-07-11 07:05:46
  from 'C:\wamp64\www\cloudcrm\layouts\v7\modules\Vtiger\RelatedActivities.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_6870b7ca11eb17_73394902',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '66dc1a23a9be92f3a656ff19384f5382fb0bdeaf' => 
    array (
      0 => 'C:\\wamp64\\www\\cloudcrm\\layouts\\v7\\modules\\Vtiger\\RelatedActivities.tpl',
      1 => 1752215006,
      2 => 'file',
    ),
  ),
...
function content_6870b7ca11eb17_73394902 (Smarty_Internal_Template $_smarty_tpl) {
...
</h4><?php $_smarty_tpl->_assignInScope('CALENDAR_MODEL', Vtiger_Module_Model::getInstance('Calendar'));?><div class="pull-left" style="display:flex; gap:10px;"><?php if ($_smarty_tpl->tpl_vars['CALENDAR_MODEL']->value->isPermitted('CreateView')) {?><button class="btn addButton btn-sm btn-default createActivity toDotask textOverflowEllipsis max-width-100" title="<?php echo vtranslate('LBL_ADD_TASK',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
...
"><span class="marginRight10px"><?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('subject');?>
</span></a><?php } else {
echo $_smarty_tpl->tpl_vars['RECORD']->value->get('subject');
}
if ($_smarty_tpl->tpl_vars['EDITVIEW_PERMITTED']->value == 'yes') {?><a href="<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getEditViewUrl();?>
...
"></i></a><?php }?></div><div><span title="<?php echo Vtiger_Util_Helper::formatDateTimeIntoDayString(((string)$_smarty_tpl->tpl_vars['START_DATE']->value)." ".((string)$_smarty_tpl->tpl_vars['START_TIME']->value));?>
...
</span></div></div><div class='col-lg-4 col-md-4 col-sm-4 activityStatus' style='line-height: 0px;padding-right:30px;'><div class=""><?php if ($_smarty_tpl->tpl_vars['RECORD']->value->get('activitytype') == 'Task') {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></style><span class="value picklist-color picklist-<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getId();?>
-<?php echo Vtiger_Util_Helper::convertSpaceToHyphen($_smarty_tpl->tpl_vars['RECORD']->value->get('status'));?>
" style="padding-left:0px"><?php echo vtranslate($_smarty_tpl->tpl_vars['RECORD']->value->get('status'),$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</span><?php if ($_smarty_tpl->tpl_vars['EDITVIEW_PERMITTED']->value == 'yes') {?><span class="editStatus cursorPointer"><i class="fa fa-pencil" title="<?php echo vtranslate('LBL_EDIT',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
