<?php
/* Smarty version 4.5.4, created on 2025-07-14 10:37:36
  from 'C:\wamp64\www\cloudcrm\layouts\v7\modules\Settings\Picklist\CreateView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_6874ddf0665e89_47016750',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9527011091c61aaab09db2377ef48594fc8b2d7b' => 
    array (
      0 => 'C:\\wamp64\\www\\cloudcrm\\layouts\\v7\\modules\\Settings\\Picklist\\CreateView.tpl',
      1 => 1752489453,
      2 => 'file',
    ),
  ),
...
function content_6874ddf0665e89_47016750 (Smarty_Internal_Template $_smarty_tpl) {
...
?><div class="modal-body"><div class="form-group"><div class="control-label col-sm-4 col-xs-4"><label><?php echo vtranslate('LBL_ITEM_VALUE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
&nbsp;<span class="redColor">*</span></label></div><div class="controls col-sm-6 col-xs-6"><input style="min-width: 220px;" name="newValue" class="form-control select2" data-rule-required="true"/></div></div><?php if ($_smarty_tpl->tpl_vars['SELECTED_PICKLIST_FIELDMODEL']->value->isRoleBased()) {?><div class="form-group"><div class="control-label col-sm-4 col-xs-4"><label><?php echo vtranslate('LBL_ASSIGN_TO_ROLE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
"></i></span></label></div><div class="controls col-sm-6 col-xs-6"><select class="rolesList form-control" name="rolesSelected[]" multiple style="min-width: 220px" data-placeholder="<?php echo vtranslate('LBL_CHOOSE_ROLES',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
"></i></div></div><?php }?><div class="form-group"><div class="control-label col-sm-4 col-xs-4"><label><?php echo vtranslate('LBL_SELECT_COLOR',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</label></div><div class="controls col-sm-6 col-xs-6"><input type="hidden" name="selectedColor" /><div class="colorPicker"></div></div></div></div><?php ob_start();
