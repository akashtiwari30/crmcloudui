    ...
    <table class = "table table-borderless bg-light-color-2" cellpadding = "30" >
        <div>
			<?php if ($_smarty_tpl->tpl_vars['FORMAT']->value == 'vcf') {?>
				<h5><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'vtranslate' ][ 0 ], array( 'LBL_IMPORT_FROM_VCF_FILE',$_smarty_tpl->tpl_vars['MODULE']->value ));?>
</h5>
			<?php } elseif ($_smarty_tpl->tpl_vars['FORMAT']->value == 'ics') {?>
				<h5><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'vtranslate' ][ 0 ], array( 'LBL_IMPORT_FROM_ICS_FILE',$_smarty_tpl->tpl_vars['MODULE']->value ));?>
</h5>
			<?php } else { ?>
				<h5><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'vtranslate' ][ 0 ], array( 'LBL_IMPORT_FROM_CSV_FILE',$_smarty_tpl->tpl_vars['MODULE']->value ));?>
</h5>
			<?php }?>
        </div>
        <tr id="file_type_container">
			<?php if ($_smarty_tpl->tpl_vars['FORMAT']->value == 'vcf') {?>
				<td><p><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'vtranslate' ][ 0 ], array( 'LBL_SELECT_VCF_FILE',$_smarty_tpl->tpl_vars['MODULE']->value ));?>
</p></td>
			<?php } elseif ($_smarty_tpl->tpl_vars['FORMAT']->value == 'ics') {?>
				<td><p><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'vtranslate' ][ 0 ], array( 'LBL_SELECT_ICS_FILE',$_smarty_tpl->tpl_vars['MODULE']->value ));?>
</p></td>
			<?php } else { ?>
				<td><p><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'vtranslate' ][ 0 ], array( 'LBL_SELECT_CSV_FILE',$_smarty_tpl->tpl_vars['MODULE']->value ));?>
</p></td>
			<?php }?>
...
echo $_smarty_tpl->tpl_vars['FORMAT']->value;
                    ...
                    <div>
                        <p id="importFileDetails" class="padding10"></p>
                    </div>
                </div>
            </td>
        </tr>
        <?php if ($_smarty_tpl->tpl_vars['FORMAT']->value == 'csv') {?>
            <tr id="has_header_container">
                <td><p><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'vtranslate' ][ 0 ], array( 'LBL_HAS_HEADER',$_smarty_tpl->tpl_vars['MODULE']->value ));?>
</p></td>
                <td>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['FORMAT']->value == 'csv') {?>
            <tr id="delimiter_container">
                <td><p><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'vtranslate' ][ 0 ], array( 'LBL_DELIMITER',$_smarty_tpl->tpl_vars['MODULE']->value ));?>
</p></td>
                <td>
                    <?php
