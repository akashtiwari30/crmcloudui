...
' /><div class="form-group"><label class="lable-name"><?php echo vtranslate('LBL_VIEW_NAME',$_smarty_tpl->tpl_vars['MODULE']->value);?>
&nbsp;<span class="redColor">*</span> </label><div class="row list-name-container"><div class="col-lg-5 col-md-5 col-sm-5"><input class="form-control list-input" type="text" data-record-id="<?php echo $_smarty_tpl->tpl_vars['RECORD_ID']->value;?>
...
'></div><div class="col-lg-5 col-md-5 col-sm-5"><label class="checkbox-inline inter-medium"><input type="checkbox" name="setdefault" value="1" <?php if ($_smarty_tpl->tpl_vars['CUSTOMVIEW_MODEL']->value->isDefault()) {?> checked="checked"<?php }?>> &nbsp;&nbsp;<?php echo vtranslate('LBL_SET_AS_DEFAULT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label><label class="checkbox-inline inter-medium"><input id="setmetrics" name="setmetrics" type="checkbox" value="1" <?php if ($_smarty_tpl->tpl_vars['CUSTOMVIEW_MODEL']->value->get('setmetrics') == '1') {?> checked="checked"<?php }?>> &nbsp;&nbsp;<?php echo vtranslate('LBL_LIST_IN_METRICS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label></label></div></div></div><div class="form-group"><label class="lable-name"><?php echo vtranslate('LBL_CHOOSE_COLUMNS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
' /></div><div class="col-lg-2 col-md-2 col-sm-2"></div></div><div><label class="filterHeaders lable-name"><?php echo vtranslate('LBL_CHOOSE_FILTER_CONDITIONS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 :</label><div class="filterElements filterConditionContainer filterConditionsDiv"><?php $_smarty_tpl->_subTemplateRender(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'vtemplate_path' ][ 0 ], array( 'AdvanceFilter.tpl' )), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?></div></div><div class="checkbox"><label class="inter-medium"><input class="inter-medium" type="hidden" name="sharelist" value="0" /><input class="inter-medium" type="checkbox" data-toogle-members="true" name="sharelist" value="1" <?php if ($_smarty_tpl->tpl_vars['LIST_SHARED']->value) {?> checked="checked"<?php }?>> &nbsp;&nbsp;<?php echo vtranslate('LBL_SHARE_THIS_LIST',$_smarty_tpl->tpl_vars['MODULE']->value);?>
