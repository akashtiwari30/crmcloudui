<?php
/* Smarty version 4.5.4, created on 2025-07-18 08:59:33
  from 'C:\wamp64\www\cloudcrm\layouts\v7\modules\Import\ImportBasicStep.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_687a0cf57340c3_00027204',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '257ad3f72b24aeb187d4d5e1183ecc499f988572' => 
    array (
      0 => 'C:\\wamp64\\www\\cloudcrm\\layouts\\v7\\modules\\Import\\ImportBasicStep.tpl',
      1 => 1752826369,
      2 => 'file',
    ),
  ),
...
function content_687a0cf57340c3_00027204 (Smarty_Internal_Template $_smarty_tpl) {
?>
<div class='fc-overlay-modal modal-content import-modal'><div class="overlayHeader"><?php ob_start();
...
}?></div></form></div><div class='modal-overlay-footer clearfix'><div class="row clearfix"><div class='textAlignCenter col-lg-12 col-md-12 col-sm-12 '><div class='footer-btns'><?php if ($_smarty_tpl->tpl_vars['FORMAT']->value == 'ics') {?><button type="submit" name="import" id="importButton" class="btn btn-submit btn-lg" onclick="return Calendar_Edit_Js.uploadAndParse();"><?php echo vtranslate('LBL_IMPORT_BUTTON_LABEL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button><a class="cancelLink" data-dismiss="modal" href="#"><?php echo vtranslate('LBL_CANCEL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</a><?php } else { ?><div id="importStepOneButtonsDiv"><?php if ((isset($_smarty_tpl->tpl_vars['DUPLICATE_HANDLING_NOT_SUPPORTED']->value)) && $_smarty_tpl->tpl_vars['DUPLICATE_HANDLING_NOT_SUPPORTED']->value == 'true') {?><button class="btn btn-submit btn-lg" id="skipDuplicateMerge" onclick="Vtiger_Import_Js.uploadAndParse('0');"><?php echo vtranslate('LBL_NEXT_BUTTON_LABEL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button><?php } else { ?><button class="btn btn-submit btn-lg" id ="importStep2" onclick="Vtiger_Import_Js.importActionStep2();"><?php echo vtranslate('LBL_NEXT_BUTTON_LABEL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</button><button name="next" class="btn btn-lg" id="uploadAndParse" onclick="Vtiger_Import_Js.uploadAndParse('1');"><?php echo vtranslate('LBL_NEXT_BUTTON_LABEL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
