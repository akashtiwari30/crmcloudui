<?php
/* Smarty version 4.5.4, created on 2025-07-14 11:01:28
  from 'C:\wamp64\www\cloudcrm\layouts\v7\modules\Settings\Webforms\FieldsEditView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_6874e38840bcd5_90976070',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '69459fb7eb3dd19dd579f7cbd3d29e6036d2650b' => 
    array (
      0 => 'C:\\wamp64\\www\\cloudcrm\\layouts\\v7\\modules\\Settings\\Webforms\\FieldsEditView.tpl',
      1 => 1752490777,
      2 => 'file',
    ),
  ),
...
function content_6874e38840bcd5_90976070 (Smarty_Internal_Template $_smarty_tpl) {
...
"/><div class="fieldBlockContainer-webform" style="margin-bottom: 0;"><div><h4 class="fieldBlockHeader"><?php echo vtranslate($_smarty_tpl->tpl_vars['SOURCE_MODULE']->value,$_smarty_tpl->tpl_vars['SOURCE_MODULE']->value);?>
 <?php echo vtranslate('LBL_FIELD_INFORMATION',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</h4></div><hr><table class="table table-bordered table-formed" width="100%" name="targetModuleFields"><colgroup><col style="width:5%;"><col style="width:5%;"><col style="width:25%;"><col style="width:40%;"><col style="width:25%;"></colgroup><tr><td colspan="5"><div class="row"><div class="col-sm-2 col-lg-2"><div class="textAlignCenter" style="margin-top:8px;"><b><?php echo vtranslate('LBL_ADD_FIELDS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</b></div></div><div class="col-sm-7 col-lg-7"><select id="fieldsList" multiple="multiple" data-placeholder="<?php echo vtranslate('LBL_SELECT_FIELDS_OF_TARGET_MODULE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></select></div><div class="col-sm-3 col-lg-3" style="margin-top: 2px"><button type="button" id="saveFieldsOrder" class="btn btn-submit" disabled="disabled"><?php echo vtranslate('LBL_SAVE_FIELDS_ORDER',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
echo vtranslate($_prefixVariable1,$_smarty_tpl->tpl_vars['SOURCE_MODULE']->value);
}
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></tbody></table></div><?php if (Vtiger_Functions::isDocumentsRelated($_smarty_tpl->tpl_vars['SOURCE_MODULE']->value)) {?><div class="fieldBlockContainer"><div><h4 class="fieldBlockHeader"><?php echo vtranslate('LBL_UPLOAD_DOCUMENTS',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</button></div></div><div class="row" style="margin-top: 10px;"><div class="col-lg-7"><table class="table table-bordered table-formed" id='fileFieldsTable'><tbody><tr><td><b><?php echo vtranslate('LBL_FIELD_LABEL',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
