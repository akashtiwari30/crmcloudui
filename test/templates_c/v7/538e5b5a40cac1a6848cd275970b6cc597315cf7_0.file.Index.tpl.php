<?php
/* Smarty version 4.5.4, created on 2025-07-10 11:59:34
  from 'C:\wamp64\www\cloudcrm\layouts\v7\modules\Settings\CustomerPortal\Index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_686fab26adcd11_00433105',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '538e5b5a40cac1a6848cd275970b6cc597315cf7' => 
    array (
      0 => 'C:\\wamp64\\www\\cloudcrm\\layouts\\v7\\modules\\Settings\\CustomerPortal\\Index.tpl',
      1 => 1752064015,
      2 => 'file',
    ),
  ),
...
function content_686fab26adcd11_00433105 (Smarty_Internal_Template $_smarty_tpl) {
?>
<div class="listViewPageDiv" id="listViewContent"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><br><form id="customerPortalForm" name="customerPortalForm" action="index.php" method="POST" class="form-horizontal"><input type="hidden" name="portalModulesInfo" value="" /><div class="col-sm-12 col-xs-12 input-group"><div class="form-group"><label for="defaultAssignee" class="col-sm-3 control-label fieldLabel"><span><?php echo vtranslate('LBL_DEFAULT_ASSIGNEE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span></label><div class="fieldValue col-lg-5 col-md-5 col-sm-5 input-group"><select name="defaultAssignee" class="select2 inputElement"><optgroup label="<?php echo vtranslate('LBL_USERS',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
" ><?php
...
"><i class="fa fa-info-circle"></i></a></div></div></div></div><div class="col-sm-12 col-xs-12 input-group"><div class="form-group"><label for="portal-url" class="col-sm-3 control-label fieldLabel"><?php echo vtranslate('LBL_PORTAL_URL',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</label><div class="col-sm-5"><a target="_blank" href="<?php echo $_smarty_tpl->tpl_vars['PORTAL_URL']->value;?>
" class="help-inline" style="width: 313px;"><?php echo $_smarty_tpl->tpl_vars['PORTAL_URL']->value;?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></ul></div><div class="col-sm-8 portal-dashboard"><div id="dashboardContent" class="show" ><h4><?php echo vtranslate('LBL_HOME_LAYOUT',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></div><div class="textAlignCenter col-lg-12 col-md-12 col-sm-12"><button type="submit" class="btn btn-submit saveButton pull-right" id="savePortalInfo" name="savePortalInfo" type="submit" disabled><?php echo vtranslate('LBL_SAVE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
