...
</label></div><div class="col-sm-2 col-xs-2"><div class="row"><div class="col-sm-8 col-xs-8"><input class="inputElement" type="text" name="days" value="<?php echo $_smarty_tpl->tpl_vars['TASK_OBJECT']->value->days;?>
