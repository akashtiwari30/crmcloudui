<?php
/* Smarty version 4.5.4, created on 2025-07-14 09:34:29
  from 'C:\wamp64\www\cloudcrm\layouts\v7\modules\Settings\LayoutEditor\FieldsList.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_6874cf25d88a76_96952178',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e8064b4d79c5200e7def0d8774078d93c7697bb7' => 
    array (
      0 => 'C:\\wamp64\\www\\cloudcrm\\layouts\\v7\\modules\\Settings\\LayoutEditor\\FieldsList.tpl',
      1 => 1752215006,
      2 => 'file',
    ),
  ),
...
function content_6874cf25d88a76_96952178 (Smarty_Internal_Template $_smarty_tpl) {
...
</button></div><div class="col-sm-6"><?php if ($_smarty_tpl->tpl_vars['IS_SORTABLE']->value) {?><span class="pull-right"><button class="btn btn-submit saveFieldSequence" type="button" style="opacity:0;margin-right:0px;"><?php echo vtranslate('LBL_SAVE_LAYOUT',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
" class="editFieldsTable edit-layoutfield-table block_<?php echo $_smarty_tpl->tpl_vars['BLOCK_ID']->value;?>
 marginBottom10px <?php if ($_smarty_tpl->tpl_vars['IS_BLOCK_SORTABLE']->value) {?> blockSortable<?php }?>" data-block-id="<?php echo $_smarty_tpl->tpl_vars['BLOCK_ID']->value;?>
...
"><div class="col-sm-12"><div class="layoutBlockHeader row"><div class="blockLabel col-sm-3 padding10 marginLeftZero" style="word-break: break-all; display:flex; align-items:center;"><?php if ($_smarty_tpl->tpl_vars['IS_BLOCK_SORTABLE']->value) {?><img class="cursorPointerMove" src="<?php echo vimage_path('drag.png');?>
...
</strong></div><div class="col-sm-9 padding10 marginLeftZero"><div class="blockActions" style="float:right !important;"><span class="collapseblock-btn"><i class="fa fa-info-circle" title="<?php echo vtranslate('LBL_COLLAPSE_BLOCK_DETAIL_VIEW',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
if ((isset($_smarty_tpl->tpl_vars['__smarty_foreach_fieldlist']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_fieldlist']->value['index'] : null)%2 == 0) {?><li class="sortable-list"><div class="sortable-block"><div class=""><div class="opacity editFields marginLeftZero" data-block-id="<?php echo $_smarty_tpl->tpl_vars['BLOCK_ID']->value;?>
...
"><div class="edit-header"><?php $_smarty_tpl->_assignInScope('IS_MANDATORY', $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatory());?><div class=""><div class="fieldLabelContainer roww"><h6 class="fieldLabel"><?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label'),$_smarty_tpl->tpl_vars['SELECTED_MODULE_NAME']->value);?>
&nbsp;<?php if ($_smarty_tpl->tpl_vars['IS_MANDATORY']->value) {?><span class="redColor">*</span><?php }?></h6><p class="field-type"><?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataTypeLabel(),$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</p></div></div><div class=""><?php if ($_smarty_tpl->tpl_vars['IS_FIELDS_SORTABLE']->value) {?><img src="<?php echo vimage_path('drag.png');?>
" class="cursorPointerMove" border="0" title="<?php echo vtranslate('LBL_DRAG',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
"/><?php }?></div></div></div></div><div class="fieldPropertyContainer"><div class="row"><?php ob_start();
...
"><div class="row"><div class="col-sm-6 edit-field mandatory switch text-capitalize <?php if ((!$_smarty_tpl->tpl_vars['IS_MANDATORY']->value)) {?>disabled<?php }?> <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatoryOptionDisabled()) {?> cursorPointerNotAllowed <?php } else { ?> cursorPointer <?php }?>"data-toggle="tooltip" <?php if ($_smarty_tpl->tpl_vars['IS_MANDATORY']->value) {?> title="<?php echo $_smarty_tpl->tpl_vars['NOT_M_FIELD_TITLE']->value;?>
...
</div><?php $_smarty_tpl->_assignInScope('IS_QUICK_EDIT_ENABLED', $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isQuickCreateEnabled());?><div class="col-sm-6 edit-field quickCreate switch <?php if ((!$_smarty_tpl->tpl_vars['IS_QUICK_EDIT_ENABLED']->value)) {?>disabled<?php }
...
</div><?php $_smarty_tpl->_assignInScope('IS_MASS_EDIT_ENABLED', $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMassEditable());?><div class="col-sm-6 edit-field massEdit switch <?php if ((!$_smarty_tpl->tpl_vars['IS_MASS_EDIT_ENABLED']->value)) {?> disabled <?php }
...
</div><?php $_smarty_tpl->_assignInScope('IS_HEADER_FIELD', $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isHeaderField());?><div class="col-sm-6 edit-field header switch <?php if ((!$_smarty_tpl->tpl_vars['IS_HEADER_FIELD']->value)) {?> disabled <?php }
...
</div><?php $_smarty_tpl->_assignInScope('IS_SUMMARY_VIEW_ENABLED', $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isSummaryField());?><div class="col-sm-6 edit-field summary switch <?php if ((!$_smarty_tpl->tpl_vars['IS_SUMMARY_VIEW_ENABLED']->value)) {?> disabled <?php }
...
</div><div class="defaultValue col-sm-6 edit-field <?php if (!$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->hasDefaultValue()) {?>disabled<?php }
...
</span></div><?php }?></div></div></div><span class="col-sm-2 actions"><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isEditable()) {?><a href="javascript:void(0)" class="editFieldDetails"><i class="fa fa-pencil" title="<?php echo vtranslate('LBL_EDIT',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
"></i></a><?php }
...
if ($_smarty_tpl->tpl_vars['BLOCK_MODEL']->value->isAddCustomFieldEnabled()) {?><li class="dummyRow"><p class="dragUiText"><?php echo vtranslate('LBL_ADD_NEW_FIELD_HERE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</p><div class=""><button class="btn btn-default btn-sm addButton"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo vtranslate('LBL_ADD',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</button></div></li><?php }
...
$_smarty_tpl->_assignInScope('FIELD_INFO', $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldInfo());
if ((isset($_smarty_tpl->tpl_vars['__smarty_foreach_fieldlist1']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_fieldlist1']->value['index'] : null)%2 != 0) {?><li class="sortable-list"><div class="sortable-block"><div class=""><div class="opacity editFields marginLeftZero" data-block-id="<?php echo $_smarty_tpl->tpl_vars['BLOCK_ID']->value;?>
" data-field-id="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('id');?>
"data-sequence="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('sequence');?>
" data-field-name="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name');?>
"><div class="roww edit-header"><?php $_smarty_tpl->_assignInScope('IS_MANDATORY', $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatory());?><div class=""><div class="fieldLabelContainer"><h6 class="fieldLabel"><?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label'),$_smarty_tpl->tpl_vars['SELECTED_MODULE_NAME']->value);
if ($_smarty_tpl->tpl_vars['IS_MANDATORY']->value) {?>&nbsp;<span class="redColor">*</span><?php }?></h6><p class="field-type"><?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataTypeLabel(),$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</p></div></div><div class=""><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isEditable() && $_smarty_tpl->tpl_vars['IS_FIELDS_SORTABLE']->value) {?><img src="<?php echo vimage_path('drag.png');?>
" class="cursorPointerMove" border="0" title="<?php echo vtranslate('LBL_DRAG',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
"/><?php }?></div></div></div></div><div class="fieldPropertyContainer"><div class="row"><?php $_smarty_tpl->_assignInScope('IS_MANDATORY', $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatory());?><div class="fieldProperties col-sm-10" data-field-id="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('id');?>
"><div class="row"><div class="col-sm-6 edit-field mandatory switch text-capitalize <?php if ((!$_smarty_tpl->tpl_vars['IS_MANDATORY']->value)) {?>disabled<?php }?> <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatoryOptionDisabled()) {?> cursorPointerNotAllowed <?php } else { ?> cursorPointer <?php }?>"data-toggle="tooltip" <?php if ($_smarty_tpl->tpl_vars['IS_MANDATORY']->value) {?> title="<?php echo $_smarty_tpl->tpl_vars['NOT_M_FIELD_TITLE']->value;?>
" <?php } else { ?> title="<?php echo $_smarty_tpl->tpl_vars['M_FIELD_TITLE']->value;?>
" <?php }?>><i class="fa fa-exclamation-circle" data-name="mandatory" data-enable-value="M" data-disable-value="O"<?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatoryOptionDisabled()) {?>readonly="readonly"<?php }?>></i>&nbsp;<?php echo vtranslate('LBL_PROP_MANDATORY',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</div><?php $_smarty_tpl->_assignInScope('IS_QUICK_EDIT_ENABLED', $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isQuickCreateEnabled());?><div class="col-sm-6 edit-field quickCreate switch <?php if ((!$_smarty_tpl->tpl_vars['IS_QUICK_EDIT_ENABLED']->value)) {?>disabled<?php }
...
</button></div></div></div><div class="blockFieldsList row blockFieldsSortable"><ul class="connectedSortable col-sm-6 ui-sortable"name="sortable1"><li class="dummyRow"><p class="dragUiText"><?php echo vtranslate('LBL_ADD_NEW_FIELD_HERE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</p><div class=""><button class="btn btn-default btn-sm addButton"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo vtranslate('LBL_ADD',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</button></div></li></ul><ul class="connectedSortable col-sm-6 ui-sortable" name="sortable2"></ul></div></div><li class="newCustomFieldCopy hide"><div class="row border1px"><div class="col-sm-4"><div class="marginLeftZero" data-field-id="" data-sequence=""><div class="row"><span class="col-sm-1">&nbsp;<?php if ($_smarty_tpl->tpl_vars['IS_SORTABLE']->value) {?><img src="<?php echo vimage_path('drag.png');?>
" class="dragImage" border="0" title="<?php echo vtranslate('LBL_DRAG',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
"/><?php }?></span><div class="col-sm-9" style="word-wrap: break-word;"><div class="fieldLabelContainer row"><span class="fieldLabel"><b></b>&nbsp;</span><div><span class="pull-right fieldTypeLabel" style="opacity:0.6;"></span></div></div></div></div></div></div><div class="col-sm-88 fieldPropertyContainer"><div class="row " style="padding:10px 0px"><div class="fieldProperties col-sm-10" data-field-id=""><span class="mandatory switch text-capitalize"><i class="fa fa-exclamation-circle" data-name="mandatory" data-enable-value="M" data-disable-value="O" title="<?php echo vtranslate('LBL_MANDATORY',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</a></div><button class="btn btn-submit" type="submit" name="reactivateButton"><strong><?php echo vtranslate('LBL_REACTIVATE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
