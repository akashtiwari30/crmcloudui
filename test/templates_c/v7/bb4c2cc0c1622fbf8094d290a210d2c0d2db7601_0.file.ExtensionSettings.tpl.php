<?php
/* Smarty version 4.5.4, created on 2025-07-14 11:24:55
  from 'C:\wamp64\www\cloudcrm\layouts\v7\modules\Google\ExtensionSettings.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_6874e9070534b8_47286720',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'bb4c2cc0c1622fbf8094d290a210d2c0d2db7601' => 
    array (
      0 => 'C:\\wamp64\\www\\cloudcrm\\layouts\\v7\\modules\\Google\\ExtensionSettings.tpl',
      1 => 1752492292,
      2 => 'file',
    ),
  ),
...
function content_6874e9070534b8_47286720 (Smarty_Internal_Template $_smarty_tpl) {
...
<div class="col-sm-12 col-xs-12 extensionContents">
	<div class="row">
		<div class="col-sm-12 col-xs-12">
			<h4 class="module-title pull-left"> <?php echo vtranslate('LBL_SELECT_MODULES_TO_SYNC',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 </h4>
		</div>
	</div>
	<br>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
		...
		<?php if (!$_smarty_tpl->tpl_vars['IS_SYNC_READY']->value) {?>
			<div class="row>
				<div class="col-sm-12 col-xs-12">
					<h4 class="module-title pull-left marginTop15px" marginBottom15px"> <?php echo vtranslate('LBL_GOOGLE_CONNECT_MSG',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 </h4>
				</div>
			</div>
...
'><i class="fa fa-google-plus"></i><?php echo vtranslate('LBL_SIGN_IN_WITH_GOOGLE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
		...
		<?php } else { ?>
			<div class="row">
				<div class="col-sm-12 col-xs-12">
					<h4 class="module-title pull-left"> <?php echo vtranslate('LBL_GOOGLE_ACCOUNT_DETAILS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 </h4>
				</div>
			</div>
			<br>
...
'><i class="fa fa-google-plus"></i> <?php echo vtranslate('LBL_CHANGE_USER',$_smarty_tpl->tpl_vars['MODULE']->value);?>
		...
		<div class="row">
			<div class="col-sm-12 col-xs-12">
				<div class="vt-default-callout vt-info-callout marginLeft10px"> 
					<h4 class="vt-callout-header"><span class="fa fa-info-circle"></span>&nbsp; Info </h4><br>
					<div>
						<p><?php echo vtranslate('LBL_REDIRECT_URL_MESSAGE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</p>
						<p><?php echo vtranslate('LBL_REDIRECT_URL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 : <span class="primary-text-color"><?php echo Google_Config_Connector::getRedirectUrl();?>
</span>
						</p>
					</div>
					<br>
		...
		<div style="margin-top: 15px; margin-left: 15px;">
			<div>
				<button id="saveSettings" type="submit" class="btn btn-submit saveButton"><?php echo vtranslate('LBL_SAVE_SETTINGS',$_smarty_tpl->tpl_vars['MODULENAME']->value);?>
</button>
