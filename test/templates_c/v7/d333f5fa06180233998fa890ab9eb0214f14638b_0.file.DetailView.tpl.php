<?php
/* Smarty version 4.5.4, created on 2025-07-15 06:29:32
  from 'C:\wamp64\www\cloudcrm\layouts\v7\modules\Settings\Profiles\DetailView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_6875f54c167c26_71702332',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd333f5fa06180233998fa890ab9eb0214f14638b' => 
    array (
      0 => 'C:\\wamp64\\www\\cloudcrm\\layouts\\v7\\modules\\Settings\\Profiles\\DetailView.tpl',
      1 => 1752560969,
      2 => 'file',
    ),
  ),
...
function content_6875f54c167c26_71702332 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
</button></div></div></div><div class="profileDetailView detailViewInfo"><div class="row form-group"><div class="col-lg-2 col-md-2 col-sm-2 control-label fieldLabel"><label><?php echo vtranslate('LBL_PROFILE_NAME',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</label></div><div class="fieldValue col-lg-6 col-md-6 col-sm-12 control-label fieldLabel" name="profilename" id="profilename" value="<?php echo $_smarty_tpl->tpl_vars['RECORD_MODEL']->value->getName();?>
"><span><?php echo $_smarty_tpl->tpl_vars['RECORD_MODEL']->value->getName();?>
</span></div></div><div class="row form-group"><div class="col-lg-2 col-md-2 col-sm-2 control-label fieldLabel"><label><?php echo vtranslate('LBL_DESCRIPTION',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
:</label></div><div class="fieldValue col-lg-6 col-md-6 col-sm-12 control-label fieldLabel" name="description" id="description"><span><?php echo $_smarty_tpl->tpl_vars['RECORD_MODEL']->value->getDescription();?>
</span></div></div><br><?php ob_start();
...
if ($_smarty_tpl->tpl_vars['RECORD_MODEL']->value->hasGlobalReadPermission()) {?><div class="row"><div class="col-lg-10 col-md-10 col-sm-10"><div><img class="alignMiddle" src="<?php if ($_smarty_tpl->tpl_vars['RECORD_MODEL']->value->hasGlobalReadPermission()) {
echo $_smarty_tpl->tpl_vars['ENABLE_IMAGE_PATH']->value;
} else {
echo $_smarty_tpl->tpl_vars['DISABLE_IMAGE_PATH']->value;
}?>" />&nbsp;<span><?php echo vtranslate('LBL_VIEW_ALL',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span><div class="input-info-addon"><i class="fa fa-info-circle"></i>&nbsp;<span ><?php echo vtranslate('LBL_VIEW_ALL_DESC',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span></div><div><img class="alignMiddle" src="<?php if ($_smarty_tpl->tpl_vars['RECORD_MODEL']->value->hasGlobalWritePermission()) {
echo $_smarty_tpl->tpl_vars['ENABLE_IMAGE_PATH']->value;
} else {
echo $_smarty_tpl->tpl_vars['DISABLE_IMAGE_PATH']->value;
}?>" />&nbsp;<span><?php echo vtranslate('LBL_EDIT_ALL',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span><div class="input-info-addon"><i class="fa fa-info-circle"></i>&nbsp;<span><?php echo vtranslate('LBL_EDIT_ALL_DESC',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span></div></div></div></div></div><?php }?><div class="row"><div class="col-lg-12 col-md-12 col-sm-12 profile-view-table"><table class="table"><thead><tr class='blockHeader'><th width="27%" style="text-align: left !important"><?php echo vtranslate('LBL_MODULES',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</span></div><div class="clearfix"></div></div><table class="table table-bordereddd profile-view-subtable"><?php $_smarty_tpl->_assignInScope('COUNTER', 0);
...
-fields" style="display: none"><div class="col-sm-12"><div><h6 class="themeTextColor font-x-large pull-left"><?php echo vtranslate('LBL_TOOLS',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</h6></div></div><table class="table table-borderedd table-striped"><?php $_smarty_tpl->_assignInScope('UTILITY_ACTION_COUNT', 0);
