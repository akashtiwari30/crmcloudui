		...
		<div class="modal-footer">
			<div class="row-fluid">
				<div class="pull-right">
					...
					<button class="btn btn-submit updateBtn"><?php echo vtranslate('Update',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button>
				</div>
			</div>
		</div>
...
" />
				...
				<div class="form-group">
					...
					<div class="controls col-sm-5">
						...
						<br>
						<br>
						<a href="#" id="forgotPasswordLink" style="color: #000 !important"><?php echo vtranslate('LBL_FORGOT_PASSWORD',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
 ?</a>
					</div>
				</div>
			</div>
...
<a onclick=window.open("http://community.vtiger.com/help/vtigercrm/php/extension-loader.html")><?php echo vtranslate('LBL_READ_HERE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
		...
		<div class="modal-footer">
			<div class="row-fluid">
				<div class="pull-right">
					<div class="pull-right cancelLinkContainer">
						<button class="btn btn-submit" data-dismiss="modal"><?php echo vtranslate('LBL_OK',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</button>
					</div>
				</div>
			</div>
