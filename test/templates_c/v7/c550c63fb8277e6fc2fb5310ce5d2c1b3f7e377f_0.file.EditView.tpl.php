<?php
/* Smarty version 4.5.4, created on 2025-07-10 06:43:15
  from 'C:\wamp64\www\cloudcrm\layouts\v7\modules\Settings\Workflows\EditView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_686f6103f139a0_14510742',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c550c63fb8277e6fc2fb5310ce5d2c1b3f7e377f' => 
    array (
      0 => 'C:\\wamp64\\www\\cloudcrm\\layouts\\v7\\modules\\Settings\\Workflows\\EditView.tpl',
      1 => 1752064015,
      2 => 'file',
    ),
  ),
...
function content_686f6103f139a0_14510742 (Smarty_Internal_Template $_smarty_tpl) {
...
</h4></div></div></div><div class="editViewBody"><div class="editViewContents" style="text-align: center; "><div class="form-group"><label for="name" class="col-sm-3 control-label"><?php echo vtranslate('LBL_WORKFLOW_NAME',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
" ></div><?php } else { ?><select class="select2 col-sm-12 pull-left" id="module_name" name="module_name" required="true" data-placeholder="Select Module..." style="text-align: left"><?php
...
</h4></div></div></div><div class="editViewBody"><div class="editViewContents" style="padding-bottom: 0px;"><?php $_smarty_tpl->_subTemplateRender(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'vtemplate_path' ][ 0 ], array( 'WorkFlowTrigger.tpl',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value )), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?></div></div><div id="workflow_condition"></div><div class="modal-overlay-footer clearfix"><div class="row clearfix"><div class='textAlignCenter col-lg-12 col-md-12 col-sm-12 '><button type='submit' class='btn btn-submit saveButton' ><?php echo vtranslate('LBL_SAVE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
