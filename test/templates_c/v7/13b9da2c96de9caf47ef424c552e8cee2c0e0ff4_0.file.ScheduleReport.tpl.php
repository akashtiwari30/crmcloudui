<?php
/* Smarty version 4.5.4, created on 2025-07-11 10:07:24
  from 'C:\wamp64\www\cloudcrm\layouts\v7\modules\Reports\ScheduleReport.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_6870e25cd0bbc7_09451261',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '13b9da2c96de9caf47ef424c552e8cee2c0e0ff4' => 
    array (
      0 => 'C:\\wamp64\\www\\cloudcrm\\layouts\\v7\\modules\\Reports\\ScheduleReport.tpl',
      1 => 1752228443,
      2 => 'file',
    ),
  ),
...
function content_6870e25cd0bbc7_09451261 (Smarty_Internal_Template $_smarty_tpl) {
...
</option></select></div></div><div class='col-lg-12 <?php if ($_smarty_tpl->tpl_vars['scheduleid']->value != 2) {?> hide <?php }?>' id='scheduledWeekDay' style='padding:5px 0px;'><div class='col-lg-3' style='position:relative;top:5px;'><label><?php echo vtranslate('LBL_ON_THESE_DAYS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label></div><div class='col-lg-4'><?php $_smarty_tpl->_assignInScope('dayOfWeek', Zend_Json::decode($_smarty_tpl->tpl_vars['SCHEDULEDREPORTS']->value->get('schdayoftheweek')));?><select style='width:280px;' multiple class='select2' name='schdayoftheweek' data-rule-required="true" id='schdayoftheweek'><option value="7" <?php if (is_array($_smarty_tpl->tpl_vars['dayOfWeek']->value) && in_array('7',$_smarty_tpl->tpl_vars['dayOfWeek']->value)) {?> selected <?php }?>><?php echo vtranslate('LBL_DAY0','Calendar');?>
...
</option></select></div></div><div class='col-lg-12 <?php if ($_smarty_tpl->tpl_vars['scheduleid']->value != 3) {?> hide <?php }?>' id='scheduleMonthByDates' style="padding:5px 0px;"><div class='col-lg-3' style='position:relative;top:5px;'><label><?php echo vtranslate('LBL_ON_THESE_DAYS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label></div><div class='col-lg-4'><?php $_smarty_tpl->_assignInScope('dayOfMonth', Zend_Json::decode($_smarty_tpl->tpl_vars['SCHEDULEDREPORTS']->value->get('schdayofthemonth')));?><select style="width: 280px !important;" multiple class="select2 col-lg-6" data-rule-required="true" name='schdayofthemonth' id='schdayofthemonth' ><?php
...
?></select></div></div><div class='col-lg-12 <?php if ($_smarty_tpl->tpl_vars['scheduleid']->value != 5) {?> hide <?php }?>' id='scheduleByDate' style="padding:5px 0px;"><div class='col-lg-3' style='position:relative;top:5px;'><label><?php echo vtranslate('LBL_CHOOSE_DATE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label></div><div class='col-lg-2'><div class="input-group inputElement date" style="margin-bottom: 3px"><?php $_smarty_tpl->_assignInScope('specificDate', Zend_Json::decode($_smarty_tpl->tpl_vars['SCHEDULEDREPORTS']->value->get('schdate')));
...
" data-rule-required="true" /><span class="input-group-addon"><i class="fa fa-calendar "></i></span></div></div></div><div class='col-lg-12 <?php if ($_smarty_tpl->tpl_vars['scheduleid']->value != 4) {?> hide <?php }?>' id='scheduleAnually' style='padding:5px 0px;'><div class='col-lg-3' style='position:relative;top:5px;'><label><?php echo vtranslate('LBL_SELECT_MONTH_AND_DAY',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label></div><div class='col-lg-5'><div id='annualDatePicker'></div></div><div class='col-lg-3'><div style='padding-bottom:5px;'><?php echo vtranslate('LBL_SELECTED_DATES',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></select></div></div></div><div class='col-lg-12' id='scheduledTime' style='padding:5px 0px 10px 0px;'><div class='col-lg-3' style='position:relative;top:5px;'><label> <?php echo vtranslate('LBL_AT_TIME',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label><span class="redColor">*</span></div><div class='col-lg-4' id='schtime'><div class='input-group inputElement time'><input type='text' class='timepicker-default form-control ui-timepicker-input' data-format='<?php echo $_smarty_tpl->tpl_vars['CURRENT_USER']->value->get('hour_format');?>
' name='schtime' value="<?php echo $_smarty_tpl->tpl_vars['SCHEDULEDREPORTS']->value->get('schtime');?>
" data-rule-required="true" data-rule-time="true" /><span class="input-group-addon"><i class="fa fa-clock-o"></i></span></div></div></div><div class='col-lg-12' id='recipientsList' style='padding:5px 0px 10px 0px;'><div class='col-lg-3' style='position:relative;top:5px;'><label><?php echo vtranslate('LBL_SELECT_RECIEPIENTS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label><span class="redColor">*</span></div><div class='col-lg-4'><?php $_smarty_tpl->_assignInScope('ALL_ACTIVEUSER_LIST', $_smarty_tpl->tpl_vars['CURRENT_USER']->value->getAccessibleUsers());
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></optgroup></select></div></div><div class='col-lg-12' id='specificemailsids' style='padding:5px 0px 10px 0px;'><div class='col-lg-3' style='position:relative;top:5px;'><label><?php echo vtranslate('LBL_SPECIFIC_EMAIL_ADDRESS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label></div><div class='col-lg-4'><?php $_smarty_tpl->_assignInScope('specificemailids', Zend_Json::decode($_smarty_tpl->tpl_vars['SCHEDULEDREPORTS']->value->get('specificemails')));?><input id="specificemails" style="width: 281px !important;" class="col-lg-6 inputElement" type="text" value="<?php echo $_smarty_tpl->tpl_vars['specificemailids']->value;?>
" name="specificemails" data-validation-engine="validate[funcCall[Vtiger_MultiEmails_Validator_Js.invokeValidation]]"></input></div></div><?php if ($_smarty_tpl->tpl_vars['TYPE']->value != 'Chart') {?><div class='col-lg-12' id='fileformat' style='padding:5px 0px 10px 0px;'><div class='col-lg-3' style='position:relative;top:5px;'><label><?php echo vtranslate('LBL_FILE_FORMAT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label></div><div class='col-lg-4'><select class="select2 inputElement" id='fileformat' name='fileformat' data-validation-engine="validate[required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" ><option value="CSV" <?php if ($_smarty_tpl->tpl_vars['SCHEDULEDREPORTS']->value->get('fileformat') == 'CSV') {?> selected <?php }?> data-picklistvalue= 'CSV'>CSV</option><option value="XLS" <?php if ($_smarty_tpl->tpl_vars['SCHEDULEDREPORTS']->value->get('fileformat') == 'XLS') {?> selected <?php }?> data-picklistvalue= 'XLS'>Excel</option></select></div></div><?php }
