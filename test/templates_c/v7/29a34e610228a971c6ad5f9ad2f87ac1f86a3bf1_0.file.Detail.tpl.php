<?php
/* Smarty version 4.5.4, created on 2025-07-07 11:49:55
  from 'C:\wamp64\www\cloudcrm\layouts\v7\modules\Settings\ExtensionStore\Detail.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_686bb463058070_16419058',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '29a34e610228a971c6ad5f9ad2f87ac1f86a3bf1' => 
    array (
      0 => 'C:\\wamp64\\www\\cloudcrm\\layouts\\v7\\modules\\Settings\\ExtensionStore\\Detail.tpl',
      1 => 1751888937,
      2 => 'file',
    ),
  ),
...
function content_686bb463058070_16419058 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\wamp64\\www\\cloudcrm\\vendor\\smarty\\smarty\\libs\\plugins\\modifier.replace.php','function'=>'smarty_modifier_replace',),));
?>
...
" /><div class="row contentHeader extension_header" style="margin-bottom: 10px;"><div class="col-sm-6 col-xs-6" style="margin-bottom: 5px;"><div style="margin-bottom: 5px; display:flex; "><p class="font-x-x-large"><?php echo $_smarty_tpl->tpl_vars['EXTENSION_DETAIL']->value->get('name');?>
</p>&nbsp;<p class="muted"><?php echo vtranslate('LBL_BY',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
&nbsp;<?php echo $_smarty_tpl->tpl_vars['AUTHOR_INFO']->value['firstname'];?>
&nbsp;<?php echo $_smarty_tpl->tpl_vars['AUTHOR_INFO']->value['lastname'];?>
</p></div><?php $_smarty_tpl->_assignInScope('ON_RATINGS', $_smarty_tpl->tpl_vars['EXTENSION_DETAIL']->value->get('avgrating'));?><div><span data-score="<?php echo $_smarty_tpl->tpl_vars['ON_RATINGS']->value;?>
...
</a>&nbsp;</span><span style="margin: 5px"><?php if (($_smarty_tpl->tpl_vars['MODULE_ACTION']->value == 'Installed')) {?><button class="btn btn-danger <?php if (($_smarty_tpl->tpl_vars['REGISTRATION_STATUS']->value) && ($_smarty_tpl->tpl_vars['PASSWORD_STATUS']->value)) {?>authenticated <?php } else { ?> loginRequired<?php }?>" type="button" style="margin-right: 6px;" id="uninstallModule"><?php echo vtranslate('LBL_UNINSTALL',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</button><?php } else {
...
if (($_smarty_tpl->tpl_vars['REGISTRATION_STATUS']->value) && ($_smarty_tpl->tpl_vars['PASSWORD_STATUS']->value)) {?> authenticated <?php } else { ?> loginRequired<?php }?>" type="button" id="installExtension"><?php echo vtranslate('LBL_BUY',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
$<?php echo $_smarty_tpl->tpl_vars['EXTENSION_DETAIL']->value->get('price');?>
</button><?php } elseif ((!$_smarty_tpl->tpl_vars['EXTENSION_DETAIL']->value->get('isprotected')) && ($_smarty_tpl->tpl_vars['EXTENSION_DETAIL']->value->get('price') > 0)) {?><button class="btn btn-info <?php if ((!$_smarty_tpl->tpl_vars['CUSTOMER_PROFILE']->value['CustomerCardId'])) {?> setUpCard<?php }
if (($_smarty_tpl->tpl_vars['REGISTRATION_STATUS']->value) && ($_smarty_tpl->tpl_vars['PASSWORD_STATUS']->value)) {?> authenticated <?php } else { ?> loginRequired<?php }?>" type="button" id="installExtension"><?php echo vtranslate('LBL_BUY',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
$<?php echo $_smarty_tpl->tpl_vars['EXTENSION_DETAIL']->value->get('price');?>
</button><?php } elseif (!$_smarty_tpl->tpl_vars['EXTENSION_DETAIL']->value->get('isprotected') && (($_smarty_tpl->tpl_vars['EXTENSION_DETAIL']->value->get('price') == 0) || ($_smarty_tpl->tpl_vars['EXTENSION_DETAIL']->value->get('price') == 'Free'))) {?><button class="btn btn-success <?php if (($_smarty_tpl->tpl_vars['REGISTRATION_STATUS']->value) && ($_smarty_tpl->tpl_vars['PASSWORD_STATUS']->value)) {?>authenticated <?php } else { ?> loginRequired<?php }?>" type="button" id="installExtension"><?php echo vtranslate($_smarty_tpl->tpl_vars['MODULE_ACTION']->value,$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
'"><?php echo vtranslate('LBL_LAUNCH',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</button></span></div><div class="clearfix"></div></div></div><div class="tabbable-panel"><div class="tabbable-line margin0px" style="padding-bottom: 20px;"><ul id="extensionTab" class="nav nav-tabs" style="margin-bottom: 0px; padding-bottom: 0px;text-align: left;"><li class="active"><a href="#description" data-toggle="tab"><span><?php echo vtranslate('LBL_DESCRIPTION',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span></a></li><li class="divider-vertical"></li><li><a href="#CustomerReviews" data-toggle="tab"><span><?php echo vtranslate('LBL_CUSTOMER_REVIEWS',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span></a></li><li class="divider-vertical"></li><li><a href="#Author" data-toggle="tab"><span><?php echo vtranslate('LBL_PUBLISHER',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span></a></li></ul><div class="tab-content boxSizingBorderBox"><div class="tab-pane active" id="description"><div><div class="row"><div class="col-sm-12 col-xs-12"><div id="imageSlider" class="carousel slide" data-ride="carousel"><!-- Indicators --><ol class="carousel-indicators"><?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></div><!-- Controls --><a class="left carousel-control" href="#imageSlider" role="button" data-slide="prev"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span><span class="sr-only"></span></a><a class="right carousel-control" href="#imageSlider" role="button" data-slide="next"><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span><span class="sr-only"></span></a></div></div></div></div><br><div class="scrollableTab" style="text-align: left;"><p><?php echo $_smarty_tpl->tpl_vars['EXTENSION_DETAIL']->value->get('description');?>
...
" class="rating" data-readonly="true"></span><div><span>out of 5</span></div><div><span>(<?php echo php7_count($_smarty_tpl->tpl_vars['CUSTOMER_REVIEWS']->value);?>
 Reviews)</span></div></div></div><?php if (($_smarty_tpl->tpl_vars['REGISTRATION_STATUS']->value) && ($_smarty_tpl->tpl_vars['PASSWORD_STATUS']->value)) {?><div class="col-sm-6 col-xs-6"><div class="pull-right"><button type="button" class="writeReview margin0px pull-right <?php if ($_smarty_tpl->tpl_vars['MODULE_ACTION']->value != 'Installed') {?> hide<?php }?>"><?php echo vtranslate('LBL_WRITE_A_REVIEW',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></div></div></div><div class="tab-pane" id="Author"><div class="scrollableTab"><div class="row extension_header"><div class="col-sm-6 col-xs-6"><?php if (!empty($_smarty_tpl->tpl_vars['AUTHOR_INFO']->value['company'])) {?><div class="font-x-x-large authorInfo"><h5><?php echo $_smarty_tpl->tpl_vars['AUTHOR_INFO']->value['company'];?>
</h5></div><?php } else { ?><div class="font-x-x-large authorInfo"><h5><?php echo $_smarty_tpl->tpl_vars['AUTHOR_INFO']->value['firstname'];?>
&nbsp;<?php echo $_smarty_tpl->tpl_vars['AUTHOR_INFO']->value['lastname'];?>
</h5></div><?php }?><div class="authorInfo"><span><?php echo $_smarty_tpl->tpl_vars['AUTHOR_INFO']->value['phone'];?>
</span></div><div class="authorInfo"><span><?php echo $_smarty_tpl->tpl_vars['AUTHOR_INFO']->value['email'];?>
</span></div><div class="authorInfo"><a href="<?php echo $_smarty_tpl->tpl_vars['AUTHOR_INFO']->value['website'];?>
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['AUTHOR_INFO']->value['website'];?>
</a></div></div></div></div></div></div></div></div><div class="modal-dialog customerReviewModal hide"><div class="modal-content"><div class="modal-header contentsBackground"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h3><?php echo vtranslate('LBL_CUSTOMER_REVIEW',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</a></div><button class="btn btn-success" type="submit" name="saveButton"><?php echo vtranslate('LBL_SAVE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button></div></div></div></div></form></div></div><?php } else { ?><div class="row"><div class="col-sm-12 col-xs-12"><?php echo $_smarty_tpl->tpl_vars['ERROR_MESSAGE']->value;?>
