<?php
/* Smarty version 4.5.4, created on 2025-06-25 04:45:09
  from 'C:\wamp64\www\cloudcrm\layouts\v7\modules\Vtiger\Header.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_685b7ed57e8015_87379620',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0b57289642f187b6b6968dbb36d077496ff256bc' => 
    array (
      0 => 'C:\\wamp64\\www\\cloudcrm\\layouts\\v7\\modules\\Vtiger\\Header.tpl',
      1 => 1750826707,
      2 => 'file',
    ),
  ),
...
function content_685b7ed57e8015_87379620 (Smarty_Internal_Template $_smarty_tpl) {
...
'><link rel="stylesheet" type="text/css" href="layouts/v7/resources/root.css" /><link rel="stylesheet" type="text/css" href="layouts/v7/resources/customcrm.css" /><link rel="stylesheet" type="text/css" href="layouts/v7/resources/commoncrm.css" /><input type="hidden" id="inventoryModules" value=<?php echo ZEND_JSON::encode($_smarty_tpl->tpl_vars['INVENTORY_MODULES']->value);?>
...
"><?php echo '</script'; ?>
><?php echo '<script'; ?>
 src="<?php echo vresource_url('layouts/v7/resources/commonscript.js');?>
"><?php echo '</script'; ?>
><?php echo '<script'; ?>
...
" /><div id="page"><?php if ($_smarty_tpl->tpl_vars['LoGGED_IN']->value == 'true') {
$_smarty_tpl->_subTemplateRender("file:modules/Vtiger/partials/SidebarHeader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
}?><!-- Sidebar/Menu Area --><!-- Begin Main Content Area --><div class="main-dashboard-content"><div class="header-wrapper" style="width: 100%;"></div><div id="pjaxContainer" class="hide noprint"></div><div id="messageBar" class="hide"></div><?php }
}
