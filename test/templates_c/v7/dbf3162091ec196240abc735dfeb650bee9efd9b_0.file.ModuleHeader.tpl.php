<?php
/* Smarty version 4.5.4, created on 2025-07-07 05:32:37
  from 'C:\wamp64\www\cloudcrm\layouts\v7\modules\Vtiger\ModuleHeader.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_686b5bf5802767_16194862',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'dbf3162091ec196240abc735dfeb650bee9efd9b' => 
    array (
      0 => 'C:\\wamp64\\www\\cloudcrm\\layouts\\v7\\modules\\Vtiger\\ModuleHeader.tpl',
      1 => 1751866300,
      2 => 'file',
    ),
  ),
...
function content_686b5bf5802767_16194862 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php if ($_smarty_tpl->tpl_vars['MODULE']->value != 'Home') {?><div class="test col-sm-11 col-xs-10 padding0 module-action-bar clearfix coloredBorderTop"><div class="module-action-content clearfix <?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
-module-action-content"><div class="col-lg-6 col-md-6 col-sm-6 col-xs-11 padding0 module-breadcrumb module-breadcrumb-<?php echo $_smarty_tpl->tpl_vars['REQ']->value->get('view');?>
...
">&nbsp;&nbsp;<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('label');?>
 &nbsp;&nbsp;</a></p><?php }?></div><div class="col-lg-6 col-md-6 col-sm-6 col-xs-1 padding0 pull-right"><div id="appnav" class="navbar-right"><nav class="navbar navbar-inverse border0 margin0"><?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['MODULE_BASIC_ACTIONS']->value) > 0) {?><div class="" style="padding: 1px 5px 0px 0px;"><div class="navbar-header bg-white marginTop5px"><button type="button" class="navbar-toggle collapsed margin0" data-toggle="collapse" data-target="#appnavcontent" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></button></div><div class="navbar-collapse collapse" id="appnavcontent" aria-expanded="false" style="height: 1px;"><ul class="nav navbar-nav"><?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></ul></div></li><?php }?></ul></div><!-- /.navbar-collapse --></div><!-- /.container-fluid --><?php }?></nav></div></div></div><?php }
...
><?php }
if ($_smarty_tpl->tpl_vars['MODULE']->value != 'Home') {?></div> <?php }
}
}
