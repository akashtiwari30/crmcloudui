<?php
/* Smarty version 4.5.4, created on 2025-07-14 10:37:56
  from 'C:\wamp64\www\cloudcrm\layouts\v7\modules\Settings\Picklist\EditView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_6874de041cf2c4_10517868',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '59d5f45669e7e5d7e9a9016b04d212ca27123b64' => 
    array (
      0 => 'C:\\wamp64\\www\\cloudcrm\\layouts\\v7\\modules\\Settings\\Picklist\\EditView.tpl',
      1 => 1752488483,
      2 => 'file',
    ),
  ),
...
function content_6874de041cf2c4_10517868 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
' /><div class="modal-body tabbable"><div class="form-group"><div class="control-label col-sm-3 col-xs-3"><label><?php echo vtranslate('LBL_ITEM_TO_RENAME',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</label></div><div class="controls col-sm-6 col-xs-6"><?php $_smarty_tpl->_assignInScope('PICKLIST_VALUES', $_smarty_tpl->tpl_vars['SELECTED_PICKLISTFIELD_EDITABLE_VALUES']->value);?><select class="select2 form-control" name="oldValue"><?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);
}?></select></div><br></div><div class="form-group"><div class="control-label col-sm-3 col-xs-3"><label><span class="redColor">*</span><?php echo vtranslate('LBL_ENTER_NEW_NAME',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</label></div><div class="controls col-sm-6 col-xs-6"><input class="form-control" type="text" name="renamedValue" <?php if (in_array($_smarty_tpl->tpl_vars['FIELD_VALUE']->value,$_smarty_tpl->tpl_vars['SELECTED_PICKLISTFIELD_NON_EDITABLE_VALUES']->value)) {?> disabled='disabled' <?php }?> data-rule-required="true" value="<?php echo Vtiger_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['FIELD_VALUE']->value);?>
"></div></div><div class="form-group"><div class="control-label col-sm-3 col-xs-3"><label><?php echo vtranslate('LBL_SELECT_COLOR',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</label></div><div class="controls col-sm-6 col-xs-6"><input type="hidden" name="selectedColor" value="<?php echo Settings_Picklist_Module_Model::getPicklistColor($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name'),$_smarty_tpl->tpl_vars['FIELD_VALUE_ID']->value);?>
