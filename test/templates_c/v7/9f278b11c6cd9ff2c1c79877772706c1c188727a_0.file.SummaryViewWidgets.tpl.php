<?php
/* Smarty version 4.5.4, created on 2025-07-04 07:19:33
  from 'C:\wamp64\www\cloudcrm\layouts\v7\modules\Potentials\SummaryViewWidgets.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_68678085f10369_26544243',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9f278b11c6cd9ff2c1c79877772706c1c188727a' => 
    array (
      0 => 'C:\\wamp64\\www\\cloudcrm\\layouts\\v7\\modules\\Potentials\\SummaryViewWidgets.tpl',
      1 => 1751613572,
      2 => 'file',
    ),
  ),
...
function content_68678085f10369_26544243 (Smarty_Internal_Template $_smarty_tpl) {
...
</div></div><?php if ($_smarty_tpl->tpl_vars['DOCUMENT_WIDGET_MODEL']->value) {?><div id="documentWidgetContainer"><div class="summaryWidgetContainer"><div class="widgetContainer_documents" data-url="<?php echo $_smarty_tpl->tpl_vars['DOCUMENT_WIDGET_MODEL']->value->getUrl();?>
...
</a></li></ul></div></div><?php }?></div><div class="widget_contents"></div></div></div></div><?php }?></div><div class="middle-block col-lg-4 col-md-4 col-sm-4"><div id="relatedActivities"><?php echo $_smarty_tpl->tpl_vars['RELATED_ACTIVITIES']->value;?>
</div><?php if ($_smarty_tpl->tpl_vars['COMMENTS_WIDGET_MODEL']->value) {?><div id="commentWidgetContainer"><div class="summaryWidgetContainer"><div class="widgetContainer_comments" data-url="<?php echo $_smarty_tpl->tpl_vars['COMMENTS_WIDGET_MODEL']->value->getUrl();?>
...
</h4></div><div class="widget_contents"></div></div></div></div><?php }?></div><div class="right-block col-lg-4 col-sm-4 col-md-4"><?php if ($_smarty_tpl->tpl_vars['PRODUCT_WIDGET_MODEL']->value) {?><div id="productWidgetContainer"><div class="summaryWidgetContainer"><div class="widgetContainer_products" data-url="<?php echo $_smarty_tpl->tpl_vars['PRODUCT_WIDGET_MODEL']->value->getUrl();?>
...
</button></div><?php }?></div><div class="widget_contents"></div></div></div></div><?php }
if ($_smarty_tpl->tpl_vars['CONTACT_WIDGET_MODEL']->value) {?><div id="contactWidgetContainer"><div class="summaryWidgetContainer"><div class="widgetContainer_contacts" data-url="<?php echo $_smarty_tpl->tpl_vars['CONTACT_WIDGET_MODEL']->value->getUrl();?>
...
"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo vtranslate('LBL_ADD',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</button></div><?php }?></div><div class="widget_contents"></div></div></div></div><?php }?></div>
<?php }
}
