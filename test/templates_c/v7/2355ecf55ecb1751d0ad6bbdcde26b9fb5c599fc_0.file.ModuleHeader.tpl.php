<?php
/* Smarty version 4.5.4, created on 2025-07-07 05:47:13
  from 'C:\wamp64\www\cloudcrm\layouts\v7\modules\Settings\Vtiger\ModuleHeader.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_686b5f6184c538_90530496',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2355ecf55ecb1751d0ad6bbdcde26b9fb5c599fc' => 
    array (
      0 => 'C:\\wamp64\\www\\cloudcrm\\layouts\\v7\\modules\\Settings\\Vtiger\\ModuleHeader.tpl',
      1 => 1751866244,
      2 => 'file',
    ),
  ),
...
function content_686b5f6184c538_90530496 (Smarty_Internal_Template $_smarty_tpl) {
...
<div class="col-sm-12 col-xs-12 module-action-bar clearfix coloredBorderTop"><div class="module-action-content clearfix"><div class="col-lg-6 col-md-6 "><?php if ($_smarty_tpl->tpl_vars['USER_MODEL']->value->isAdminUser()) {?><a title="<?php echo vtranslate('Home',$_smarty_tpl->tpl_vars['MODULE']->value);?>
" href='index.php?module=Vtiger&parent=Settings&view=Index'><h4 class="module-title pull-left text-uppercase"><?php echo vtranslate('LBL_HOME',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 </h4></a>&nbsp;<span class="fa fa-angle-right pull-left <?php if ($_smarty_tpl->tpl_vars['VIEW']->value == 'Index' && $_smarty_tpl->tpl_vars['MODULE']->value == 'Vtiger') {?> hide <?php }?>" aria-hidden="true" style="padding-left: 5px; padding-right: 5px;"></span><?php }
...
}?></div><div class="col-lg-6 col-md-6 pull-right"><div id="appnav" class="navbar-right"><ul class="nav navbar-nav"><?php
