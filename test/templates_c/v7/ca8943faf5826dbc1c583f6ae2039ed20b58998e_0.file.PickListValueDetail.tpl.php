<?php
/* Smarty version 4.5.4, created on 2025-06-26 10:48:14
  from 'C:\wamp64\www\cloudcrm\layouts\v7\modules\Settings\Picklist\PickListValueDetail.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_685d256e802c30_66694856',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ca8943faf5826dbc1c583f6ae2039ed20b58998e' => 
    array (
      0 => 'C:\\wamp64\\www\\cloudcrm\\layouts\\v7\\modules\\Settings\\Picklist\\PickListValueDetail.tpl',
      1 => 1750934875,
      2 => 'file',
    ),
  ),
...
function content_685d256e802c30_66694856 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></style><?php $_smarty_tpl->_assignInScope('NON_DELETABLE_VALUES', $_smarty_tpl->tpl_vars['SELECTED_PICKLIST_FIELDMODEL']->value->getNonEditablePicklistValues($_smarty_tpl->tpl_vars['SELECTED_PICKLIST_FIELDMODEL']->value->getName()));?><ul class="nav nav-tabs massEditTabs" style="margin-bottom: 0;"><li class="tab-btn active"><a href="#allValuesLayout" data-toggle="tab"><?php echo vtranslate('LBL_ALL_VALUES',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</a></li><?php if ($_smarty_tpl->tpl_vars['SELECTED_PICKLIST_FIELDMODEL']->value->isRoleBased()) {?><li class="tab-btn" id="assignedToRoleTab"><a href="#AssignedToRoleLayout" data-toggle="tab"><?php echo vtranslate('LBL_VALUES_ASSIGNED_TO_A_ROLE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</a></li><?php }?></ul><div class="tab-content layoutContent padding20 themeTableColor overflowVisible"><div class="tab-pane active" id="allValuesLayout"><div class="row"><div class="col-lg-12 col-md-12 col-sm-12"><table id="pickListValuesTable" class="table" style="table-layout: fixed"><thead><tr class="listViewHeaders"><th><span><?php echo vtranslate($_smarty_tpl->tpl_vars['SELECTED_PICKLIST_FIELDMODEL']->value->get('label'),$_smarty_tpl->tpl_vars['SELECTED_MODULE_NAME']->value);?>
...
?></div></div><br><?php if ($_smarty_tpl->tpl_vars['SELECTED_PICKLIST_FIELDMODEL']->value->isRoleBased()) {?><div class="tab-pane form-horizontal row" id="AssignedToRoleLayout"><div class="col-lg-12 col-md-12 col-sm-12"><div class="form-group row"><label class="control-label col-lg-12 col-md-12 col-sm-12"><?php echo vtranslate('LBL_ROLE_NAME',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</label><div class="controls col-lg-5 col-md-5 col-sm-5"><select id="rolesList" class="select2 inputElement" name="rolesSelected" data-placeholder="<?php echo vtranslate('LBL_CHOOSE_ROLES',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
"><?php
