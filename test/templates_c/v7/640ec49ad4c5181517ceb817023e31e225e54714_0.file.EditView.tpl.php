<?php
/* Smarty version 4.5.4, created on 2025-07-11 07:02:51
  from 'C:\wamp64\www\cloudcrm\layouts\v7\modules\EmailTemplates\EditView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_6870b71bdc37d2_48014227',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '640ec49ad4c5181517ceb817023e31e225e54714' => 
    array (
      0 => 'C:\\wamp64\\www\\cloudcrm\\layouts\\v7\\modules\\EmailTemplates\\EditView.tpl',
      1 => 1752064015,
      2 => 'file',
    ),
  ),
...
function content_6870b71bdc37d2_48014227 (Smarty_Internal_Template $_smarty_tpl) {
?>
<div class="main-container clearfix"><div class="editViewPageDiv viewContent"><div class="col-sm-12 col-xs-12 content-area"><form id="EditView" class="form-horizontal recordEditView" name="EditView" method="post" action="index.php"><div class="editViewHeader"><div class='row'><div class="col-lg-12 col-md-12 col-lg-pull-0"><?php $_smarty_tpl->_assignInScope('SINGLE_MODULE_NAME', ('SINGLE_').($_smarty_tpl->tpl_vars['MODULE']->value));
if ($_smarty_tpl->tpl_vars['RECORD_ID']->value != '') {?><h5 class="editHeader" title="<?php echo vtranslate('LBL_EDITING',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
"><?php echo vtranslate('LBL_EDITING',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 ...
 <?php echo vtranslate($_smarty_tpl->tpl_vars['SINGLE_MODULE_NAME']->value,$_smarty_tpl->tpl_vars['MODULE']->value);?>
</h5><?php }?></div></div></div><div class="editViewBody"><div class="editViewContents"><?php ob_start();
...
?></div><div class="modal-overlay-footer clearfix" style="border-left-width: 0px;"><div class="row clearfix"><div class=' textAlignCenter col-lg-12 col-md-12 col-sm-12 '><button type='submit' class='btn btn-submit saveButton'><?php echo vtranslate('LBL_SAVE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
