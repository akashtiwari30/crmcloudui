...
function getDuplicatesPreventionMessage($moduleName, $duplicateRecordsList) {
	...
	if ($currentUserModel->isAdminUser()) {
		...
		$here = '<a href="'.$url.'" target="_blank" style="color:#000 !important">'.vtranslate('LBL_CLICK_HERE', $moduleName).'</a>';
	...
	for ($i=0; $i<$duplicateRecordsCount && $i<5; $i++) {
		...
		$message .= '<a href="'.$dupliRecordModel->getDetailViewUrl().'" target="_blank" style="color:#000 !important">'.Vtiger_Functions::getCRMRecordLabel($dupliRecordId).'</a><br>';
	}
	...
	if ($duplicateRecordsCount === 6) {
		...
		$message .= "<a href='$listViewUrl' target='_blank' style='color:#000 !important'>+".  strtolower(vtranslate('LBL_MORE', $moduleName)).'</a>';
	}
