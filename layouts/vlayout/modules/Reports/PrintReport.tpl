...
<html>
	<head>
        ...
        <style>
            ...
            .printReport tr td{
                border:1px dotted var(--black-color-2);
                text-align:left;
            }
            .printReport tr th{
	...
	<body marginheight="0" marginwidth="0" leftmargin="0" topmargin="0" style="text-align:center;" onLoad="JavaScript:window.print()">
		<table width="80%" border="0" cellpadding="5" cellspacing="0" align="center">
			<tr>
				<td align="left" valign="top" style="border:0px solid var(--black-color-2);">
					<h2>{$REPORT_NAME}</h2>
					<font  color="#666666"><div id="report_info"></div></font>
				</td>
				<td align="right" style="border:0px solid var(--black-color-2);" valign="top">
					<h3 style="color:#CCCCCC">{$ROW} {'LBL_RECORDS'|@vtranslate:$MODULE}</h3>
				</td>
			</tr>
			<tr>
				<td style="border:0px solid var(--black-color-2);" colspan="2">
