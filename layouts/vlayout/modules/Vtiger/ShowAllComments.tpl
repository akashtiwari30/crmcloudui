...
<div class="commentContainer">
		...
		{if $CREATE_PERMISSION}
			<div class="addCommentBlock">
				...
				<div class="pull-right">
					<button class="btn btn-submit saveComment" type="button" data-mode="add">{vtranslate('LBL_POST', $MODULE_NAME)}</button>
				</div>
			</div>
		{/if}
	</div>
	...
	{if $EDIT_PERMISSION}
		<div class="hide basicEditCommentBlock" style="min-height: 150px;">
			...
			<div class="pull-right">
				<button class="btn btn-submit saveComment" type="button" data-mode="edit">{vtranslate('LBL_POST', $MODULE_NAME)}</button>
