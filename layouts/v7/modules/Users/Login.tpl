...
{strip}
	<style>
		...
		.buttonBlue {
			background-image: linear-gradient(to bottom, #33ed88 0px, #33ed88 100%)
		}
		.ripples {
			position: absolute;
			top: 0;
			...
			<div class="loginDiv widgetHeight">
				...
				<div id="loginFormDiv">
					...
					<div class="group">
							...
							<a class="forgotPasswordLink" style="color: #000;">forgot password?</a>
						</div>
					</form>
				</div>
				...
				<div id="forgotPasswordDiv" class="hide">
					<form class="form-horizontal" action="forgotPassword.php" method="POST">
						...
						<div class="group">
							...
							<span>Please enter details and submit<a class="forgotPasswordLink pull-right" style="color: #000;">Back</a></span>
						</div>
					</form>
				</div>
			</div>
