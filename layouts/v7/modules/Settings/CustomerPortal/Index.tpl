			...
			<form id="customerPortalForm" name="customerPortalForm" action="index.php" method="POST" class="form-horizontal">
				...
				<div class="col-sm-12 col-xs-12 input-group">					
					<div class="form-group">
						<label for="defaultAssignee" class="col-sm-3 control-label fieldLabel"><span>{vtranslate('LBL_DEFAULT_ASSIGNEE', $QUALIFIED_MODULE)}</span></label>
						<div class="fieldValue col-lg-5 col-md-5 col-sm-5 input-group">
				...
				<div class="col-sm-12 col-xs-12 input-group">
					<div class="form-group">
						<label for="portal-url" class="col-sm-3 control-label fieldLabel">{vtranslate('LBL_PORTAL_URL', $QUALIFIED_MODULE)}</label>
						<div class="col-sm-5">
							<a target="_blank" href="{$PORTAL_URL}" class="help-inline" style="width: 313px;">{$PORTAL_URL}</a>
				...
				<div class="row" style="margin-bottom: 20px; margin-top: 20px;">
					<div class="col-sm-3 paddingRight0">
						...
						<ul class="nav nav-tab nav-stacked" id="portalModulesTable">
							...
							{foreach key=TAB_ID item=MODEL from=$MODULES_MODELS name=moduleModels}
								...
								<li class="portalModuleRow bgColor cp-tabs" {if $smarty.foreach.moduleModels.last} {/if}
					...
					<div class="col-sm-8 portal-dashboard">
					...
					<div class="textAlignCenter col-lg-12 col-md-12 col-sm-12">
						<button type="submit" class="btn btn-submit saveButton pull-right" id="savePortalInfo" name="savePortalInfo" type="submit" disabled>{vtranslate('LBL_SAVE', $MODULE)}</button>&nbsp;&nbsp;
					</div>
