...
{strip}
	...
	<div class="row" id="moduleData_{$MODULE}">
		...
		<div class="col-sm-6 col-xs-6 portal-fields-container-wrapper">
			...
			<div class="roww">
				<div id="fieldRows_{$MODULE}" class="col-sm-12" style="padding:0px;">
		...
		<div class="col-sm-6 col-xs-6 portal-related-information">
			<h5 style="margin-top: 0px;">{vtranslate('LBL_RECORD_VISIBILITY',$QUALIFIED_MODULE)}</h5>
			...
			<br>
			{if $MODULE neq 'Faq'}
				<h5>{vtranslate('LBL_RELATED_INFORMATION',$QUALIFIED_MODULE)}</h5>
