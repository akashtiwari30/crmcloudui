	...
	{if $BLOCK_FIELDS|@count gt 0}
		<div class='fieldBlockContainer'>
					...
					<div class="row">
						...
						<div class="col-sm-4">
							<div class="pull-right">
								...
								<select class="select2" id="currency_id" name="currency_id" style="width: 164px;">
						...
						<div class="col-sm-4">
							<div class="pull-right">
								...
								<select class="select2 lineItemTax" id="taxtype" name="taxtype" style="width: 164px;">
			...
			<div class="lineitemTableContainer">
				<table class="table table-bordered table-formed" id="lineItemTab">
					<tr>
		...
		<br>
		<div class="fieldBlockContainer">
			<table class="table table-bordered blockContainer lineItemTable table-formed" id="lineItemResult">
				<tr>
					<td width="83%">
