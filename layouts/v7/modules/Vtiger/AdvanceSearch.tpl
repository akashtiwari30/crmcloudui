{*<!--
   ...
   ********************************************************************************/
   -->*}
{strip}
<div id="searchResults-container" class="advanceFilterContainer search-header-container">
   <div class="modal-content">
      <div class="modal-header">
         <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
               <h5 class="pull-left m-xy-0" data-result="{vtranslate('LBL_SEARCH_RESULTS', $MODULE)}" data-modify="{vtranslate('LBL_SAVE_MODIFY_FILTER', $MODULE)}">
            ...
            <div id="advanceSearchContainer">
               <div class="searchModuleComponent">
                  ...
                  <div class="col-lg-12 col-md-12">
                     *}
                     <h6 class="pull-left" style="margin-right:10px;">{vtranslate('LBL_SEARCH_IN',$MODULE)}</h6>
                  ...
                  *}
                  <div class="filterElements well filterConditionContainer" id="searchContainer" style="height: auto;">
                     <form name="advanceFilterForm" method="POST">
                        ...
                        <p class="textAlignCenter well contentsBackground">{vtranslate('LBL_PLEASE_SELECT_MODULE',$MODULE)}</p>
                        {else}
