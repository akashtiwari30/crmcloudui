...
{strip}
	...
	<div class="test col-sm-11 col-xs-10 padding0 module-action-bar clearfix coloredBorderTop">
		<div class="module-action-content clearfix {$MODULE}-module-action-content">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-11 padding0 module-breadcrumb module-breadcrumb-{$REQ->get('view')} transitionsAllHalfSecond">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-1 padding0 pull-right">
