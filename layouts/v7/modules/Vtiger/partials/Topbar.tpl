							...
							<div>
								<a href="#" class="userName dropdown-toggle pull-right" data-toggle="dropdown" role="button">
									<span class="" aria-hidden="true" title="{$USER_MODEL->get('userlabel')}
										  ({$USER_MODEL->get('user_name')})"><img class="profile-icon" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQIf4R5qPKHPNMyAqV-FjS_OTBB8pfUV29Phg&s" alt="profile icon" /></span>
									...
									<div class="row">
										...
										<div class="col-lg-8 col-sm-8">
											<div class="profile-container">
												<h5 class="profile-user">{$USER_MODEL->get('first_name')} {$USER_MODEL->get('last_name')}</h5>
												<p class="textOverflowEllipsis profile-roles" title='{$USER_MODEL->get('user_name')}'>{$USER_MODEL->get('user_name')}</p>
									...
									<div id="logout-footer" class="logout-footer clearfix">
										...
										<div class="">
											<span class="pull-left">
												...
												<a id="menubar_item_right_LBL_MY_PREFERENCES" class="my-preferences" href="{$USER_MODEL->getPreferenceDetailViewUrl()}">{vtranslate('LBL_MY_PREFERENCES')}</a>
											</span>
